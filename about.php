      ...
      <div class="container">
        ...
        <div class="row g-5 align-items-center">
          <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
            <div class="about-img position-relative overflow-hidden p-5 pe-0">
              <?php if ($row_Recordset1): ?>
                <img class="img-fluid w-100" src="img/<?php echo $row_Recordset1['image']; ?>" alt="About Image">
              <?php else: ?>
                <img class="img-fluid w-100" src="img/default-about.jpg" alt="Default About Image">
              <?php endif; ?>
            </div>
          </div>
          <div class="col-lg-6 wow fadeIn" dir="rtl" data-wow-delay="0.5s">
            ...
            <?php else: ?>
              <h1 class="mb-4">No Data Found</h1>
              <p class="mb-4">There is no information available for this section.</p>
            <?php endif; ?>
          </div>
        </div>
      </div>
