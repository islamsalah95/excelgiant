...
mysqli_select_db($connection, "excelgia_mahmdata");
$query_Recordset2 = "SELECT * FROM books ORDER BY id DESC";
...
<table width="100%" border="0" cellpadding="2" cellspacing="2" dir="rtl">
  <tr>
    <td align="center" valign="top"><h2><strong></strong></h2>
      <table width="100%" border="0" cellpadding="2" cellspacing="2" dir="rtl">
        <tr>
          <td align="center"><h2><strong>الكتب الالكترونية</strong></h2></td>
        </tr>
        <tr>
          <td><hr /></td>
        </tr>
        <tr>
          <td><table width="100" border="0" align="left" cellpadding="0" cellspacing="0">
            <tr>
              <td height="30" align="center" bgcolor="#D9EAF4"><a href="booksadd.php"><i class="fa fa-plus" aria-hidden="true"></i> إضافة </a></td>
            </tr>
          </table></td>
        </tr>
        <tr>
          <td>            <table id="myTable" width="95%" border="1" align="center" dir="rtl">
              <tr bgcolor="#7470B3">
                ...
                <th nowrap="nowrap"><strong>تاريخ رفع الكتاب</strong></th>
                <th nowrap="nowrap"><strong>عنوان الكتاب</strong></th>
                <th nowrap="nowrap">رابط الكتاب</th>
              ...
              <?php do { ?>
                <tr align="center" valign="middle">
                  ...
                  <td><a href="../books/<?php echo $row_Recordset2['image']; ?>" target="_new"><img src="../down.png" width="50" border="0" /></a></td>
                  <td><?php echo $row_Recordset2['OrderAddress']; ?><br></td>
                  <td><?php echo $row_Recordset2['OrderSDate']; ?></td>
                  <td><a href="booksdelete.php?id=<?php echo $row_Recordset2['id']; ?>">حذف</a></td>
                </tr>
