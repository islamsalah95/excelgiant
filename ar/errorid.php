...
$query_Recordset1 = sprintf("SELECT * FROM members WHERE id_card = %s", GetSQLValueString($colname_Recordset1, "int"));
...
<table width="100%" border="0" align="center" cellpadding="4" cellspacing="4" dir="rtl">
  ...
  <tr>
    <td align="center"><h2>عفوا... الرقم الوطني مسجل بالفعل خاص بالعضو</h2></td>
  </tr>
  <tr>
  ...
  <tr>
    <td align="center"><h2>يرجى ادخال رقم وطني غير مسجل مسبقا </h2></td>
  </tr>
  <tr>
