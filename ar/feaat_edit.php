...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE category SET categoryName=%s, categoryDescription=%s, image=%s, creationDate=%s, updationDate=%s WHERE id=%s",
...
mysqli_select_db($connection, "excelgia_mahmdata");
$query_Recordset1 = sprintf("SELECT * FROM category WHERE id = %s", GetSQLValueString($colname_Recordset1, "int"));
      ...
      <form action="<?php echo $editFormAction; ?>" method="post" enctype = "multipart/form-data" name="form1" id="form1">
        <table align="center">
          <tr valign="baseline">
            ...
            <td><input type="text" name="categoryName" value="<?php echo htmlentities($row_Recordset1['categoryName'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
          </tr>
          <tr valign="baseline">
            <td nowrap="nowrap" align="right" valign="top">وصف القسم:</td>
            <td><textarea name="categoryDescription" cols="50" rows="5"><?php echo htmlentities($row_Recordset1['categoryDescription'], ENT_COMPAT, 'utf-8'); ?></textarea></td>
          </tr>
          <tr valign="baseline">
        ...
        <input type="hidden" name="creationDate" value="<?php echo htmlentities($row_Recordset1['creationDate'], ENT_COMPAT, 'utf-8'); ?>" />
