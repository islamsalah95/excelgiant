...
<table border="0" align="center" cellpadding="4" cellspacing="4" dir="rtl">
  <tr>
    ...
    <td align="center">&nbsp;</td>
    <td align="center"><a href="form1_fprint.php">
      <button>طباعة</button>
    </a></td>
  </tr>
</table>
        ...
        <td><table width="100%" border="0" cellpadding="2" cellspacing="2">
          <tr align="center" valign="top">
            <td width="100"><table width="130" border="1" cellspacing="0" cellpadding="0">
              <tr>
                <td height="130"><strong><img src="https://chart.googleapis.com/chart?chs=300x300&amp;cht=qr&amp;chl=https://libyanpharmacists.com/users/validation.php?id=<?php echo $row_Recordset1['nekaba']; ?>&amp;icon=" alt="لوحة التحكم" width="130" height="130" border="0" title="لوحة التحكم"%2F&choe=UTF-8&quot; /></strong></td>
              </tr>
            </table></td>
            ...
            <td width="130"><table width="130" border="1" cellspacing="0" cellpadding="0">
              <tr>
                <td height="130" align="center" valign="middle"><strong><img src="../img/<?php echo $row_Recordset1['per_img']; ?>" alt="" width="100" height="100" /></strong></td>
              </tr>
            </table></td>
          </tr>
          <tr>
            <td colspan="3" valign="top"><p><span dir="rtl">عليه يؤذن للصيدلي&nbsp;:</span><strong><span dir="rtl"> <?php echo $row_Recordset1['saidly_name']; ?><br />
              </span></strong><span dir="rtl">بمزاولة مهنة الصيدلة&nbsp;بوظيفة :</span><strong> <?php echo $row_Recordset1['job_name']; ?> بـ <?php echo $row_Recordset1['activity_name']; ?><span dir="rtl"> <br />
                </span></strong></p>
              <strong><?php echo $row_Recordset1['text3']; ?></strong>
              <p>وينتهي  صلاحيته بتاريخ : <strong><?php echo $row_Recordset1['exp_date']; ?> </strong> وأن رقم قيده بالنقابة العامة  للصيادلة :<strong>&nbsp;<?php echo $row_Recordset1['nekaba']; ?>، وقد تم دفع الرسوم بالسند رقم <?php echo $row_Recordset1['sanad_id']; ?>.<br />
