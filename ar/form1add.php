...
<table width="100%" border="0" cellpadding="2" cellspacing="2" dir="rtl">
  <tr>
    <td align="center"><h2><strong>نموذج إذن مزاولة مهنة الصيدلة </strong></h2></td>
  </tr>
  <tr>
    <td><hr /></td>
  </tr>
...
?>
  ...
  <table align="center">
    <tr valign="baseline">
      ...
      <td colspan="2"><input name="form_type" type="text" value="إذن مزاولة مهنة الصيدلة" size="32" readonly="readonly" /></td>
      </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      ...
      <td rowspan="4" align="center" valign="top"><img src="../img/<?php echo $row_RSMemper['per_img']; ?>" width="70" height="100" /></td>
      </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right"><span dir="rtl">عليه يؤذن للصيدلي&nbsp;</span>:</td>
