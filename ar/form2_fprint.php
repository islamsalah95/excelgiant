        ...
        <td><table width="100%" border="0" cellpadding="2" cellspacing="2">
          ...
          <tr>
            <td colspan="3" valign="top"><h2 align="center"><strong><span dir="rtl">عليـــــــــــــه</span></strong></h2>
              <p dir="rtl"> <span dir="rtl">نفيدكم بأن الصيدلي:</span><strong><span dir="rtl"> <?php echo $row_Recordset1['saidly_name']; ?><br />
                </span></strong><span dir="rtl">أن مدة خبرته في ممارسة مهنة:</span><strong> <?php echo $row_Recordset1['text3']; ?> </strong>وأن رقم قيده بالنقابة العامة  للصيادلة:<strong>&nbsp;<?php echo $row_Recordset1['nekaba']; ?>، وقد تم دفع الرسوم بالسند رقم <?php echo $row_Recordset1['sanad_id']; ?>.<br />
                  <br />
                  * ملاحظة:<br />
              ...
              <table width="300" align="left" cellpadding="0" cellspacing="0" dir="rtl">
                <tr>
                  <td align="center"><p><strong> يعتمد،<br />
                    رئيس اللجنة التسييرية للنقابة العامة للصيادلة</strong> <br />
                    <br />
