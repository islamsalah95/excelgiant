...
?>
  ...
  <table align="center">
    <tr valign="baseline">
      ...
      <td rowspan="4" valign="top"><img src="../img/<?php echo $row_RSMemper['per_img']; ?>" width="70" height="100" /></td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      <td align="right" nowrap="nowrap">د. صيدلي:</td>
...
?>
    ...
    <tr valign="baseline">
      <td nowrap="nowrap" align="right"><span dir="rtl">مسلسل </span>:</td>
    ...
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">ملاحظات:
    ...
    <tr valign="baseline">
      <td nowrap="nowrap" align="right"><input name="text2" type="hidden" size="60" />
        ...
        <input name="print_date" type="hidden" value="<?php echo date("Y-m-d h:i:s"); ?>" size="32" />        <input type="hidden" name="nakeb_name" value="<?php echo $row_RSUsers['first_name']; ?> <?php echo $row_RSUsers['bname']; ?> <?php echo $row_RSUsers['cname']; ?> <?php echo $row_RSUsers['last_name']; ?>" size="32" /></td>
