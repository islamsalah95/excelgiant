...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO kararat (id, ServicesID, ServicesTitle, ServicesPrice, ServicesText, OrderDate, OrderName, OrderPhone, OrderAddress, OrderTown, OrderArea, OrderDetails, image, OrderFDate, OrderSDate, OrderStatus, FaniName, FaniTakiim, OrderNo) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
<?php
   if(isset($_FILES['image'])){
      ...
      if(empty($errors)==true) {
         move_uploaded_file($file_tmp,"../kararat/".$file_name);
         echo "Success";
      }else{
         print_r($errors);
      }
...
<form id="registrationForm" novalidate="novalidate">
  <div>
                              ...
                              <div class="containerform">
                                ...
                                <div class="row">
									<div class="col-25">
        								<label for="fname">عنوان القرار:</label>
      								</div>
                                    <div class="col-75">
                                ...
                                <div class="row">
									<div class="col-25">
        								<label for="fname">رقم القرار:</label>
      								</div><div class="col-75">
                                        <input type="text" name="OrderPhone" value="" size="32" required/>
                                    </div>
                                </div>    
                                <div class="row">
									<div class="col-25">
                                ...
                                <div class="row">
								  <div class="col-25">ملف القرار:</div><div class="col-75">
              ...
              <script>
                function updateFileName1() {
                    ...
                    image1.value = image.value.substring(fileNameIndex + 1);
                                ...
                                <div class="row">
									<div class="col-25">
        								<label for="fname">وصف القرار :</label>
      								</div>
                                    <div class="col-75">
                                      <textarea name="OrderSDate" cols="50" rows="2" required="required"></textarea>
                                    </div>
                                </div>
                                <div class="row">
