...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  $insertGoTo = "responsible_view.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysqli_select_db($connection, "excelgia_mahmdata");
$query_Recordset1 = sprintf("SELECT * FROM responsible WHERE sub_syndicate = %s ORDER BY id DESC", GetSQLValueString($colname_Recordset1, "text"));
...
mysqli_select_db($connection, "excelgia_mahmdata");
$query_Recordset2 = sprintf("SELECT * FROM responsible WHERE sub_syndicate = %s", GetSQLValueString($colname_Recordset2, "text"));
  ...
  <tr>
    <td>
      ...
      <table align="center">
        ...
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">الرابت:</td>
    ...
    function updateFileName2() {
        ...
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">صورة التوقيع:</td>
        ...
        <tr valign="baseline">
          ...
          <td><input type="text" name="grad_date" value="" size="32" /></td>
        </tr>
        <tr valign="baseline">
...
?>
        ...
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">المجموعة:</td>
...
?>
        ...
        <tr valign="baseline">
          <td nowrap="nowrap" align="right"><input name="create_by" type="hidden" id="create_by" value="<?php echo $row_Recordset2['id']; ?>" size="32" />
