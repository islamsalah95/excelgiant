...
$query_Recordset1 = sprintf("SELECT * FROM responsible WHERE id = %s", GetSQLValueString($colname_Recordset1, "int"));
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  ...
  $updateGoTo = "responsible_view.php?sub_syndicate=" . $row_Recordset1['sub_syndicate'] . "";
  if (isset($_SERVER['QUERY_STRING'])) {
