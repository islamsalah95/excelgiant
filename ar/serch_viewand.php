...
if (isset($_GET['member_type'])) {
  $colname2_Recordset1 = $_GET['member_type'];
}
$colname3_Recordset1 = "-1";
if (isset($_GET['aname'])) {
  $colname3_Recordset1 = $_GET['aname'];
}
$colname4_Recordset1 = "-1";
if (isset($_GET['bname'])) {
  $colname4_Recordset1 = $_GET['bname'];
}
$colname5_Recordset1 = "-1";
if (isset($_GET['cname'])) {
  $colname5_Recordset1 = $_GET['cname'];
}
$colname6_Recordset1 = "-1";
if (isset($_GET['dname'])) {
  $colname6_Recordset1 = $_GET['dname'];
}
$colname7_Recordset1 = "-1";
if (isset($_GET['id_card'])) {
  $colname7_Recordset1 = $_GET['id_card'];
}
$colname8_Recordset1 = "-1";
if (isset($_GET['member_activity'])) {
  $colname8_Recordset1 = $_GET['member_activity'];
}
mysqli_select_db($connection, "excelgia_mahmdata");
$query_Recordset1 = sprintf("SELECT * FROM members WHERE id = %s AND member_type= %s AND aname= %s AND bname= %s AND cname= %s AND dname= %s AND id_card=%s AND member_activity= %s ORDER BY id DESC", GetSQLValueString($colname1_Recordset1, "int"),GetSQLValueString($colname2_Recordset1, "text"),GetSQLValueString($colname3_Recordset1, "text"),GetSQLValueString($colname4_Recordset1, "text"),GetSQLValueString($colname5_Recordset1, "text"),GetSQLValueString($colname6_Recordset1, "text"),GetSQLValueString($colname7_Recordset1, "text"),GetSQLValueString($colname8_Recordset1, "text"));
...
<table width="100%" border="0" cellpadding="2" cellspacing="2" dir="rtl">
  <tr>
    <td align="center"><h2><strong>نتائج البحث</strong></h2></td>
  </tr>
  <tr>
    <td><hr /></td>
  </tr>
  ...
  <tr>
    <td><table id="myTable" width="95%" border="1" align="center" dir="rtl">
        <tr bgcolor="#7470B3">
          ...
          <th nowrap="nowrap"><strong>النقابة الفرعية</strong></th>
        ...
        <?php do { ?>
          <tr align="center">
            ...
            <td><strong><a href="../img/<?php echo $row_Recordset1['grad_img']; ?>" target="_new"><img src="../img/<?php echo $row_Recordset1['grad_img']; ?>" alt="" width="50" height="50" /></a></strong></td>
            <td><strong><img src="../img/<?php echo $row_Recordset1['per_img']; ?>" alt="" width="50" height="50" /></strong></td>
...
?>
            ...
            <td width="50"><a href="members_delete.php?id=<?php echo $row_Recordset1['id']; ?>&amp;usern=<?php echo $row_Recordset2['username']; ?>" target="_new"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
          </tr>
