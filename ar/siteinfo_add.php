...
mysqli_select_db($connection, "excelgia_mahmdata");
$query_Recordset1 = sprintf("SELECT * FROM siteinfo WHERE sub_syndicate = %s ORDER BY id DESC", GetSQLValueString($colname_Recordset1, "text"));
