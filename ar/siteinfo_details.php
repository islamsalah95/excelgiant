...
mysqli_select_db($connection, "excelgia_mahmdata");
$query_DetailRS1 = sprintf("SELECT * FROM siteinfo WHERE id = %s", GetSQLValueString($colname_DetailRS1, "int"));
...
mysqli_select_db($connection, "excelgia_mahmdata");
$query_rssiteinfo = "SELECT * FROM siteinfo";
  ...
  <tr>
    <td><table width="80%" align="center" cellpadding="2" cellspacing="2">
      ...
      <tr>
        ...
        <td bgcolor="#FFFFFF">&nbsp;	&nbsp;	&nbsp;<strong><img src="../img/<?php echo $row_DetailRS1['grad_img']; ?>" alt="" width="150" /></strong></td>
      </tr>
      <tr>
        <th nowrap="nowrap" bgcolor="#7470B3">وصف مختصر</th>
        <td bgcolor="#FFFFFF">&nbsp;	&nbsp;	&nbsp;<strong><?php echo $row_DetailRS1['bname']; ?></td>
      </tr>
    </table></td>
  </tr>
  <tr>
