...
if (isset($_POST['username'])) {
  ...
  $LoginRS__query=sprintf("SELECT username, password FROM siteinfo WHERE username=%s AND password=%s",
...
if (isset($_GET['first_name'])) {
  $colname_Recordset1 = $_GET['first_name'];
}
mysqli_select_db($connection, "excelgia_mahmdata");
$query_Recordset1 = sprintf("SELECT * FROM siteinfo WHERE first_name LIKE %s ORDER BY id DESC", GetSQLValueString("%" . $colname_Recordset1 . "%", "text"));
...
mysqli_select_db($connection, "excelgia_mahmdata");
$query_Recordset2 = sprintf("SELECT * FROM siteinfo WHERE username = %s", GetSQLValueString($colname_Recordset2, "text"));
...
<table width="100%" border="0" cellpadding="2" cellspacing="2" dir="rtl">
  <tr>
    <td align="center"><h2><strong>معلومات الموقع</strong></h2></td>
  </tr>
  <tr>
    <td><hr /></td>
  </tr>
  <tr>
    <td><table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
      <tr>
        <td><form id="form1" name="form1" method="get" action="../sadmin/siteinfo_view_search.php">
        ...
        <td>&nbsp;</td>
        <td>
          بحث            <script type="text/javascript">
    ...
    searchBtn.addEventListener("click", function () {
      ...
      const searchResult = window.find(search);
        ...
        <td width="100" height="30" align="center" bgcolor="#D9EAF4"><a href="siteinfo_add.php"><i class="fa fa-plus" aria-hidden="true"></i> إضافة </a></td>
  ...
  <tr>
    <td><table id="myTable" width="95%" border="1" align="center" dir="rtl">
        <tr bgcolor="#7470B3">
          <th nowrap="nowrap"><strong>مسلسل</strong></th>
          <th nowrap="nowrap"><strong>الاسم</strong></th>
          <th nowrap="nowrap"><strong>الصورة</strong></th>
          <th width="50" align="center" nowrap="nowrap"><strong>عرض</strong></th>
          <th width="50" align="center" nowrap="nowrap"><strong>تعديل</strong></th>
          <th width="50" align="center" nowrap="nowrap"><strong>حذف</strong></th>
        </tr>
        <?php do { ?>
          <tr align="center">
            <td><a href="siteinfo_details.php?recordID=<?php echo $row_Recordset1['id']; ?>"><?php echo $row_Recordset1['id']; ?></a></td>
            <td><p><?php echo $row_Recordset1['first_name']; ?> <?php echo $row_Recordset1['last_name']; ?></p></td>
            <td><strong><img src="../img/<?php echo $row_Recordset1['grad_img']; ?>" alt="" width="50" height="50" /></strong></td>
            <td width="50"><a href="siteinfo_details.php?recordID=<?php echo $row_Recordset1['id']; ?>" target="_new"><i class="fa fa-eye" aria-hidden="true"></i></a></td>
            <td width="50"><a href="siteinfo_edit.php?id=<?php echo $row_Recordset1['id']; ?>&amp;sub_syndicatea=<?php echo $row_Recordset1['sub_syndicate']; ?>" target="_new"><i class="fa fa-edit" aria-hidden="true"></i></a></td>
            <td width="50"><a href="siteinfo_delete.php?id=<?php echo $row_Recordset1['id']; ?>" target="_new"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
          </tr>
...
Records <?php echo ($startRow_Recordset1 + 1) ?> to <?php echo min($startRow_Recordset1 + $maxRows_Recordset1, $totalRows_Recordset1) ?> of <?php echo $totalRows_Recordset1 ?><table border="0" align="center" dir="ltr">
  ...
  <tr>
    <td><table width="100" border="0" align="left" cellpadding="0" cellspacing="0">
      <tr>
        <td height="30" align="center" bgcolor="#D9EAF4"><a href="siteinfo_add.php"><i class="fa fa-plus" aria-hidden="true"></i> إضافة </a></td>
      </tr>
    </table></td>
  </tr>
</table>
