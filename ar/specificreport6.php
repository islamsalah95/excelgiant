...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td><table width="500" border="1" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td><form action="query7.php" method="get" name="form1" target="_new">
          <table width="400" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td>انتهاء الصلاحية لتاريخ محدد</td>
              <td><label for="exp_date"></label>
                <input name="exp_date" type="date" id="exp_date"></td>
