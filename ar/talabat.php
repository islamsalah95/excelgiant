...
mysqli_select_db($connection, "excelgia_mahmdata");
$query_Recordset2 = "SELECT * FROM request ORDER BY id DESC";
        ...
        <tr>
          <td>            <table id="myTable" width="95%" border="1" align="center" dir="rtl">
              <tr bgcolor="#7470B3">
                ...
                <th nowrap="nowrap"><strong>رقم التليفون</strong></th>
                <th nowrap="nowrap"><strong>الرسالة</strong></th>
              </tr>
              <?php do { ?>
                <tr align="center">
                  ...
                  <td><?php echo $row_Recordset2['OrderAddress']; ?><br><?php echo $row_Recordset2['OrderTown']; ?><br><?php echo $row_Recordset2['OrderArea']; ?></td>
                </tr>
