...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO towns (id, name, syndadmin, syndadminjop, address, create_date, edit_date, create_by, edit_by) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)",
  ...
  <tr>
    <td>&nbsp;
      <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
        <table align="center">
          <tr valign="baseline">
            <td align="right" nowrap="nowrap">اسم البرنامج:</td>
            <td><input type="text" name="name" value="" size="32" /></td>
          </tr>
          <tr valign="baseline">
            <td align="right" nowrap="nowrap">الاصدار:</td>
            <td><input name="syndadmin" type="text" id="syndadmin" size="32" /></td>
          </tr>
          <tr valign="baseline">
            <td align="right" nowrap="nowrap">رابط البرنامج:</td>
            <td><input name="syndadminjop" type="text" id="syndadminjop" size="32" /></td>
          </tr>
          <tr valign="baseline">
            <td align="right" nowrap="nowrap">وصف البرنامج:</td>
            <td><textarea name="address" cols="45" rows="5" id="address"></textarea></td>
          </tr>
          <tr valign="baseline">
            <td nowrap="nowrap" align="right">&nbsp;</td>
            <td><input type="text" name="create_date" value="<?php echo date("mdYhisZ"); ?>" size="32" /></td>
          </tr>
          <tr valign="baseline">
            <td nowrap="nowrap" align="right">&nbsp;</td>
