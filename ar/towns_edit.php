...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE towns SET name=%s, syndadmin=%s, syndadminjop=%s, address=%s, create_date=%s, edit_date=%s, create_by=%s, edit_by=%s WHERE id=%s",
  ...
  <tr>
    <td>&nbsp;
      <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
        <table align="center">
          <tr valign="baseline">
            <td nowrap="nowrap" align="right">اسم البرنامج:</td>
            <td><input type="text" name="name" value="<?php echo htmlentities($row_Recordset1['name'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
          </tr>
          <tr valign="baseline">
            <td nowrap="nowrap" align="right">الاصدار:</td>
            <td><input name="syndadmin" type="text" id="syndadmin" value="<?php echo htmlentities($row_Recordset1['syndadmin']); ?>" size="32" /></td>
          </tr>
          <tr valign="baseline">
            <td nowrap="nowrap" align="right"> رابط البرنامج</td>
            <td><input name="syndadminjop" type="text" id="syndadminjop" value="<?php echo htmlentities($row_Recordset1['syndadminjop']); ?>" size="32" /></td>
          </tr>
          <tr valign="baseline">
            <td nowrap="nowrap" align="right"> وصف البرنامج:</td>
            <td><textarea name="address" cols="45" rows="5" id="address"><?php echo $row_Recordset1['address']; ?></textarea></td>
          </tr>
          <tr valign="baseline">
            <td nowrap="nowrap" align="right">&nbsp;</td>
            <td><input type="text" name="create_date" value="<?php echo date("mdYhisZ"); ?>" /></td>
          </tr>
          <tr valign="baseline">
            <td nowrap="nowrap" align="right">&nbsp;</td>
