...
<table width="100%" border="0" cellpadding="2" cellspacing="2" dir="rtl">
  <tr>
    <td align="center"><h2><strong>تحميل البرامج</strong></h2></td>
  </tr>
  <tr>
    <td><hr /></td>
  </tr>
  ...
  <script type="text/javascript">
    ...
    searchBtn.addEventListener("click", function () {
      ...
      const searchResult = window.find(search);
        ...
        <td height="30" align="center" bgcolor="#D9EAF4"><a href="towns_add.php"><i class="fa fa-plus" aria-hidden="true"></i> إضافة </a></td>
  ...
  <tr>
    <td><table id="myTable" width="95%" border="1" align="center" dir="rtl">
        <tr bgcolor="#7470B3">
          <th><strong>اسم البرنامج</strong></th>
          <th width="100">الاصدار</th>
          <th width="100">كود التحميل</th>
          <th width="50" align="center" nowrap="nowrap"><strong>تعديل</strong></th>
          <th width="50" align="center" nowrap="nowrap"><strong>حذف</strong></th>
          <th width="50" align="center" nowrap="nowrap">الرابط</th>
        </tr>
        <?php do { ?>
          <tr align="center">
            <td><p><?php echo $row_Recordset1['name']; ?> </p></td>
            <td width="100"><?php echo $row_Recordset1['syndadmin']; ?></td>
            <td width="100"><?php echo $row_Recordset1['create_date']; ?></td>
            <td width="50"><a href="towns_edit.php?id=<?php echo $row_Recordset1['id']; ?>" target="_new"><i class="fa fa-edit" aria-hidden="true"></i></a></td>
            <td width="50"><a href="towns_delete.php?id=<?php echo $row_Recordset1['id']; ?>" target="_new"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
            <td width="50"><a href="https://new.excelgiants.site/members/mempers_download.php?id=<?php echo $row_Recordset1['id']; ?>" target="_new"><i class="fa fa-download" aria-hidden="true"></i></a></td>
          </tr>
