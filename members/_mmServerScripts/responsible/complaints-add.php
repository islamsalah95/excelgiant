...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO complaints (id, details, viewed, create_date, edit_date, create_by, edit_by) VALUES (%s, %s, %s, %s, %s, %s, %s)",
            ...
            <tr>
              <td align="left">&nbsp;
                <form method="post" name="form1" action="<?php echo $editFormAction; ?>create_by=<?php echo $row_Recordset1['id']; ?>">
                  <table align="center">
                    <tr valign="baseline">
                      <td nowrap align="right" valign="top">تفاصيل الشكوى:</td>
