...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE complaints SET details=%s, viewed=%s, create_date=%s, edit_date=%s, create_by=%s, edit_by=%s WHERE id=%s",
...
mysqli_query($connection, $query)($database_connection, $connection);
$query_Recordset2 = sprintf("SELECT * FROM complaints WHERE id = %s", GetSQLValueString($colname_Recordset2, "int"));
      ...
      <div class="w3-container w3-card w3-white w3-margin-bottom">
        ...
        <div class="w3-container"><br>
          <table width="100%" cellpadding="4" cellspacing="4">
            <tr>
              <td align="center" bgcolor="#CCFFFF"><h1>تقديم شكوى</h1></td>
            </tr>
          </table>
            ...
            <tr>
              <td align="left">&nbsp;
                <form method="post" name="form1" action="<?php echo $editFormAction; ?>create_by=<?php echo $row_Recordset1['id']; ?>">
                  <table align="center">
                    <tr valign="baseline">
                      <td align="right" valign="top" nowrap>تفاصيل الشكوى:</td>
                    ...
                    <tr valign="baseline">
                      <td nowrap align="right"><input type="hidden" name="edit_date" value="<?php echo date("Y-m-d h:i:s"); ?>" size="32">
                        <input type="hidden" name="edit_by" value="<?php echo $row_Recordset1['id']; ?>" size="32">
                        <input type="hidden" name="create_by" value="<?php echo htmlentities($row_Recordset2['create_by'], ENT_COMPAT, 'UTF-8'); ?>" size="32">
                      <input type="hidden" name="create_date" value="<?php echo htmlentities($row_Recordset2['create_date'], ENT_COMPAT, 'UTF-8'); ?>" size="32">                        <input type="hidden" name="viewed" value="<?php echo htmlentities($row_Recordset2['viewed'], ENT_COMPAT, 'UTF-8'); ?>" size="32"></td>
