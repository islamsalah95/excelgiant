...
mysqli_query($connection, $query)($database_connection, $connection);
$query_Recordset1 = sprintf("SELECT * FROM responsible WHERE username = %s", GetSQLValueString($colname_Recordset1, "text"));
...
?>
  ...
  <table align="center">
    ...
    <tr valign="baseline">
      <td colspan="3" align="right" nowrap="nowrap"><?php 
...
?></td>
    ...
    <tr valign="baseline">
      <td nowrap="nowrap" align="right"><span dir="rtl">وينتهي صلاحيته بتاريخ </span>:</td>
...
?>
    ...
    <tr valign="baseline">
      ...
      <td colspan="2"><input name="print_by" type="text" value="<?php echo $row_Recordset1['first_name']; ?> <?php echo $row_Recordset1['bname']; ?> <?php echo $row_Recordset1['cname']; ?> <?php echo $row_Recordset1['last_name']; ?>" size="32" /></td>
      </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      ...
      <td colspan="2"><label for="sanadvalue"></label>
