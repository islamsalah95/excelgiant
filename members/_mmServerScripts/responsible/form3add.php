...
?>
  ...
  <table align="center">
    <tr valign="baseline">
      ...
      <td colspan="2"><input name="form_type" type="text" value="إذن فتح" size="32" readonly="readonly" /></td>
      </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">اذن فتح:</td>
      <td><input name="job_name" type="text" size="32" /></td>
      </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">&nbsp;</td>
      <td>&nbsp;</td>
    ...
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">ويحمل صفة:</td>
      <td colspan="2"><textarea name="activity_name" cols="60" rows="5"></textarea></td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      ...
      <td colspan="2"><input type="text" name="exp_date" value="<?php echo date("Y-m-d"); ?>" size="32" /></td>
      </tr>
    <tr valign="baseline">
