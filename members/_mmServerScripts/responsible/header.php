...
$query_ReHeader = sprintf("SELECT * FROM responsible WHERE username = %s", GetSQLValueString($colname_ReHeader, "text"));
...
$colname_RSforms = $_SESSION['MM_Username'];
if (isset($_GET['username'])) {
  $colname_RSforms = $_GET['username'];
}
$colname2_RSforms = "1";
if (isset($_GET['forms'])) {
  $colname2_RSforms = $_GET['forms'];
}
mysqli_query($connection, $query)($database_connection, $connection);
$query_RSforms = sprintf("SELECT * FROM perm WHERE username = %s AND forms=%s", GetSQLValueString($colname_RSforms, "text"),GetSQLValueString($colname2_RSforms, "text"));
$RSforms = mysqli_query($connection,$query_RSforms) or die(mysqli_error($connection));
$row_RSforms = mysqli_fetch_assoc($RSforms);
$totalRows_RSforms = mysqli_num_rows($RSforms);
...
<div class="topnav" id="myTopnav" style="">
  ...
  <div>
    <p align="center">Energy Fitness Center - مرحباً يا : <?php echo $_SESSION['MM_Username'] ?> - <strong><?php echo $row_ReHeader['first_name']; ?></strong> <strong><?php echo $row_ReHeader['bname']; ?></strong> <strong><?php echo $row_ReHeader['cname']; ?></strong> <strong><?php echo $row_ReHeader['last_name']; ?></strong></p>
...
<div class="w3-container w3-card w3-white w3-margin-bottom" style="background-image: linear-gradient(WHITE, WHITE,  WHITE,  WHITE,  WHITE,  WHITE, gray);">
  ...
  <tr>
    ...
    <td rowspan="2" align="center" valign="top"><p><img src="../lo.png" alt="" width="150"><br>
    </p>
      <p> <strong><a href="attend_add.php"><img src="attend.png" alt="" width="70" border="0" title="تسجيل الحضور"/></a></strong></p></td>
  ...
  <div class="content">
    <ul id="sdt_menu" class="sdt_menu">
      ...
      <a href="#"> <img src="2.jpg" alt=""/> <span class="sdt_active"></span> <span class="sdt_wrap"> <span class="sdt_link">البحث</span> <span class="sdt_descr"></span></span></a>
      
      
      
      
        <div class="sdt_box">      
<?php if ($totalRows_RSsearches> 0) { // Show if recordset not empty ?>    
<a href="searches.php">البحث</a>
<?php } // Show if recordset not empty ?>
      ...
      <a href="#"> <img src="1.jpg" alt=""/> <span class="sdt_active"></span> <span class="sdt_wrap"> <span class="sdt_link">خصائص</span> <span class="sdt_descr"></span></span></a>
...
<?php if ($totalRows_RSmail> 0) { // Show if recordset not empty ?>
<a href="mail.php">القائمة البريدية</a>
<?php } // Show if recordset not empty ?>

        
        
<?php if ($totalRows_RSbackup> 0) { // Show if recordset not empty ?>
<a href="backup.php">نسخ إحتياطي</a>
<?php } // Show if recordset not empty ?>
        
        
<?php if ($totalRows_RSrestore> 0) { // Show if recordset not empty ?>
<a href="restore.php">إستعادة نسخة</a>
<?php } // Show if recordset not empty ?>
        
        
<?php if ($totalRows_RSbanks> 0) { // Show if recordset not empty ?>
<a href="towns_view.php">الفروع</a>
<a href="banks_view.php">الاقسام</a>
<a href="university_view.php">الباقات</a>
<a href="blogsmain.php">منشورات الموقع</a>
...
<?php } // Show if recordset not empty ?>      
      ...
      <li> <a href="#"> <img src="6.jpg" alt=""/> <span class="sdt_active"></span> <span class="sdt_wrap"> <span class="sdt_link">الحسابات</span> <span class="sdt_descr"></span></span></a>
        <div class="sdt_box"> 
...
<?php if ($totalRows_RSpayments> 0) { // Show if recordset not empty ?>
<a href="payments_view.php?sub_syndicate=<?php echo $row_ReHeader['sub_syndicate']; ?>">سندات القبض</a>
<?php } // Show if recordset not empty ?>
        
        
        </div>
        </li>
      <li> <a href="reports.php"> <img src="4.jpg" alt=""/> <span class="sdt_active"></span> <span class="sdt_wrap"> <span class="sdt_link">وثائق وتقارير</span> <span class="sdt_descr"></span></span></a>
        <div class="sdt_box"> 
...
<a href="form4_view.php">بطاقة عضوية</a>
<a href="contract_view.php">عقد اشتراك</a>
<?php } // Show if recordset not empty ?>
...
<?php if ($totalRows_RSrequestes> 0) { // Show if recordset not empty ?>
        <a href="requestes_view.php?sub_syndicate=<?php echo $row_Recordset1['sub_syndicate']; ?>">الطلبات</a>
<?php } // Show if recordset not empty ?>
...
<?php if ($totalRows_RScomplaints> 0) { // Show if recordset not empty ?>
        <a href="complaints_view.php?sub_syndicate=<?php echo $row_Recordset1['sub_syndicate']; ?>">الشكاوى والملاحظات</a>
<?php } // Show if recordset not empty ?>
      ...
      <li> <a href="#"> <img src="9.jpg" alt=""/> <span class="sdt_active"></span> <span class="sdt_wrap"> <span class="sdt_link">البيانات الاساسية</span> <span class="sdt_descr"></span></span></a>
        <div class="sdt_box"> 
		
		
		
<?php if ($totalRows_RSusers> 0) { // Show if recordset not empty ?>
    <a href="users_view.php?sub_syndicate=<?php echo $row_ReHeader['sub_syndicate']; ?>">المستخدمين</a>
<?php } // Show if recordset not empty ?>
...
<a href="members_view.php?sub_syndicate=<?php echo $row_ReHeader['sub_syndicate']; ?>">الأعضاء</a>
<?php } // Show if recordset not empty ?>




<?php if ($totalRows_RSdeletedmembers> 0) { // Show if recordset not empty ?>
<a href="members_deleted.php?sub_syndicate=<?php echo $row_ReHeader['sub_syndicate']; ?>">الأعضاء المحذوفة</a>
<?php } // Show if recordset not empty ?>
