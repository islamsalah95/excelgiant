...
if (isset($_GET['member_activity'])) {
  $colname3_Recordset1 = $_GET['member_activity'];
}
mysqli_query($connection, $query)($database_connection, $connection);
$query_Recordset1 = sprintf("SELECT * FROM members WHERE sub_syndicate = %s AND deleted=%s AND member_activity=%s ORDER BY id DESC", GetSQLValueString($colname_Recordset1, "int"),GetSQLValueString($colname2_Recordset1, "text"),GetSQLValueString($colname3_Recordset1, "text"));
...
<thead>
  <tr bgcolor="">
    <th colspan="6" align="center" nowrap="nowrap"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td colspan="2" align="center"><h2><strong><span dir="rtl"> تقرير منتسبي  </span></strong></h2></td>
      </tr>
      <tr>
        <td width="50%"><strong>الفرع: 
...
?>
  ...
  <tr bgcolor="#7470B3">
    ...
    <th width="100" align="center" nowrap="nowrap"><strong>رقم العضوية</strong></th>
    <th width="100" align="center" nowrap="nowrap"><strong>الرقم القومي</strong></th>
    <th width="100" align="center" nowrap="nowrap">رقم التليفون</th>
    <th width="100" align="center" nowrap="nowrap"><strong>الفرع</strong></th>
    <th align="center" nowrap="nowrap">الوظيفة</th>
    </tr>
  </thead>
  <?php do { ?>
  <tr align="center">
...
?>
    ...
    <td align="center" nowrap="nowrap"><?php echo $row_Recordset1['work_place']; ?></td>
    </tr>
