...
mysqli_query($connection, $query)($database_connection, $connection);
$query_Recordset1 = sprintf("SELECT * FROM members WHERE deleted=%s AND member_activity=%s ORDER BY id DESC", GetSQLValueString($colname2_Recordset1, "text"),GetSQLValueString($colname3_Recordset1, "text"));
...
<thead>
  <tr bgcolor="">
    <th colspan="6" align="center" nowrap="nowrap"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td colspan="2" align="center"><h2><strong><span dir="rtl">  تقرير منتسبي نشاط محدد</span></strong></h2></td>
      </tr>
      <tr>
        <td width="50%">&nbsp;</td>
