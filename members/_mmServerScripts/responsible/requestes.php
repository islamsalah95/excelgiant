          ...
          <table width="100%" border="0" cellspacing="4" cellpadding="4">
            <tr>
              <td align="left"><table width="100" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td height="30" align="center" bgcolor="#D9EAF4"><a href="requestes-add.php"><i class="fa fa-plus" aria-hidden="true"></i> إضافة </a></td>
                </tr>
              </table></td>
            </tr>
            <tr>
              <td>
                <table border="1" align="center">
                  <tr bgcolor="#D9EAF4">
                    <td align="center">مقدم الطلب</td>
                    <td align="center">نوع الطلب</td>
                    <td align="center">تاريخ الطلب</td>
                    <td width="50" align="center">عرض</td>
                    <td width="50" align="center">تعديل</td>
                    <td width="50" align="center">حذف</td>
                  </tr>
                  <?php do { ?>
                    <tr align="center">
                      <td><?php echo $row_Recordset1['first_name']; ?> <?php echo $row_Recordset1['last_name']; ?></td>
                      <td><?php echo $row_Recordset2['requeste_type']; ?></td>
                      <td><?php echo $row_Recordset2['create_date']; ?></td>
                      <td><a href="requestes-details.php?id=<?php echo $row_Recordset2['id']; ?>"><i class="fa fa-external-link" aria-hidden="true"></i></a></td>
                      <td><a href="requestes-edit.php?id=<?php echo $row_Recordset2['id']; ?>"><i class="fa fa-edit" aria-hidden="true"></i></a></td>
                      <td><a href="requestes-delete.php?id=<?php echo $row_Recordset2['id']; ?>"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
                    </tr>
