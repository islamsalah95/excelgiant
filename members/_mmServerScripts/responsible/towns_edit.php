...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE towns SET name=%s, syndadmin=%s, syndadminjop=%s, create_date=%s, edit_date=%s, create_by=%s, edit_by=%s WHERE id=%s",
...
<table width="100%" border="0" cellpadding="2" cellspacing="2" dir="rtl">
  <tr>
    <td align="center"><h2><strong>الفروع</strong></h2></td>
  </tr>
  <tr>
    <td><hr /></td>
  </tr>
    ...
    <td>&nbsp;
      <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
        <table align="center">
          ...
          <tr valign="baseline">
            <td nowrap="nowrap" align="right">المدير:</td>
