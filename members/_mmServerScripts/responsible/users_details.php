...
<table width="100%" border="0" cellpadding="2" cellspacing="2" dir="rtl">
  ...
  <tr>
    <td><table width="80%" align="center" cellpadding="2" cellspacing="2">
      ...
      <tr>
        <th nowrap="nowrap" bgcolor="#7470B3">اسم المستخدم</th>
        <td bgcolor="#FFFFFF">&nbsp;	&nbsp;	&nbsp;<?php echo $row_DetailRS1['username']; ?></td>
      </tr>
      <tr>
        <th nowrap="nowrap" bgcolor="#7470B3">صورة شخصية</th>
        <td bgcolor="#FFFFFF">&nbsp;	&nbsp;	&nbsp;<strong><img src="../photo/<?php echo $row_DetailRS1['per_img']; ?>" alt="" width="150" height="150" /></strong></td>
      </tr>
      <tr>
        <th nowrap="nowrap" bgcolor="#7470B3">تاريخ العضوية</th>
        <td bgcolor="#FFFFFF">&nbsp;	&nbsp;	&nbsp;<?php echo $row_DetailRS1['grad_date']; ?></td>
      </tr>
      <tr>
        <th nowrap="nowrap" bgcolor="#7470B3">الباقة</th>
        <td bgcolor="#FFFFFF">&nbsp;	&nbsp;	&nbsp;
          <label for="grad_place2"></label>
          <select name="grad_place" id="grad_place2">
            <option value="" <?php if (!(strcmp("", $row_DetailRS1['grad_place']))) {echo "selected=\"selected\"";} ?>></option>
            <?php
do {  
?>
            <option value="<?php echo $row_rstowns['id']?>"<?php if (!(strcmp($row_rstowns['id'], $row_DetailRS1['grad_place']))) {echo "selected=\"selected\"";} ?>><?php echo $row_rstowns['name']?></option>
            <?php
...
?>
      ...
      <tr>
        ...
        <td bgcolor="#FFFFFF">&nbsp;	&nbsp;	&nbsp;<strong><a href="../photo/<?php echo $row_Recordset1['grad_img']; ?>" target="_new"><img src="../photo/<?php echo $row_DetailRS1['grad_img']; ?>" alt="" width="250" height="250" /></a></strong></td>
      </tr>
      <tr>
        <th nowrap="nowrap" bgcolor="#7470B3">صورة البطاقة</th>
        <td bgcolor="#FFFFFF">&nbsp;	&nbsp;	&nbsp;<strong><img src="../photo/<?php echo $row_DetailRS1['sign_img']; ?>" alt="" width="100" height="70" /></strong></td>
      </tr>
      <tr>
      ...
      <tr>
        <th nowrap="nowrap" bgcolor="#7470B3">الوظيفة</th>
        <td bgcolor="#FFFFFF">&nbsp;	&nbsp;	&nbsp;<?php echo $row_DetailRS1['job']; ?></td>
      </tr>
      <tr>
        <th nowrap="nowrap" bgcolor="#7470B3">الفرع</th>
        <td bgcolor="#FFFFFF">&nbsp;	&nbsp;	&nbsp;
...
?>
      ...
      <tr>
        <th nowrap="nowrap" bgcolor="#7470B3">المجموعة</th>
        <td bgcolor="#FFFFFF">&nbsp;	&nbsp;	&nbsp;
          <select name="select" id="select">
            <?php
do {  
?>
            <option value="<?php echo $row_Recordset3['id']?>"<?php if (!(strcmp($row_Recordset3['id'], $row_DetailRS1['group_id']))) {echo "selected=\"selected\"";} ?>><?php echo $row_Recordset3['name']?></option>
            <?php
...
do {  
?>
            <option value="<?php echo $row_rsusers['id']?>"<?php if (!(strcmp($row_rsusers['id'], $row_DetailRS1['create_by']))) {echo "selected=\"selected\"";} ?>><?php echo $row_rsusers['first_name']?> <?php echo $row_rsusers['last_name']; ?></option>
            <?php
...
?>
      ...
      <tr>
        ...
        <td bgcolor="#FFFFFF">&nbsp;	&nbsp;	&nbsp;
          <select name="active4" id="active5">
            <option value="" <?php if (!(strcmp("", $row_DetailRS1['edit_by']))) {echo "selected=\"selected\"";} ?>></option>
            <?php
do {  
?>
            <option value="<?php echo $row_rsusers['id']?>"<?php if (!(strcmp($row_rsusers['id'], $row_DetailRS1['edit_by']))) {echo "selected=\"selected\"";} ?>><?php echo $row_rsusers['first_name']; ?> <?php echo $row_rsusers['last_name']?></option>
            <?php
} while ($row_rsusers = mysqli_fetch_assoc($rsusers));
  $rows = mysqli_num_rows($rsusers);
  if($rows > 0) {
...
?>
      ...
      <tr>
        <th nowrap="nowrap" bgcolor="#7470B3">تاريخ اخر دخول</th>
        <td bgcolor="#FFFFFF">&nbsp;	&nbsp;	&nbsp;<?php echo $row_DetailRS1['last_login']; ?></td>
      </tr>
      <tr>
