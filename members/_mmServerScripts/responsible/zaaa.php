...
<div class="topnav" id="myTopnav" style="">
  ...
  <div>
    <p align="center">Energy Fitness Center - مرحباً يا : <?php echo $_SESSION['MM_Username'] ?> - <strong><?php echo $row_Recordset1['first_name']; ?></strong> <strong><?php echo $row_Recordset1['bname']; ?></strong> <strong><?php echo $row_Recordset1['cname']; ?></strong> <strong><?php echo $row_Recordset1['last_name']; ?></strong></p>
