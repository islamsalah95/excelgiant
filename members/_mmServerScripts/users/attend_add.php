...
do {  
?>
                <option value="<?php echo $row_Recordset1['Elbaka']?>"><?php echo $row_Recordset1['elbakatitle']?></option>
                <?php
                    ...
                    <td><table width="100%" align="center">
                      <tr>
                        <td width="95%" colspan="2"><table width="100%">
                          <tr align="center">
                            <td colspan="6" align="center"><h3><strong><?php echo $row_RSElodw['aname']; ?> <?php echo $row_RSElodw['bname']; ?> <?php echo $row_RSElodw['cname']; ?> <?php echo $row_RSElodw['dname']; ?></strong></h3></td>
                          </tr>
                          <tr align="right">
                            <td align="center" bgcolor="#EEEEEE"><strong>الباقة</strong></td>
                            <td align="center" bgcolor="#EEEEEE"><strong>القسم</strong></td>
                            <td align="center" bgcolor="#EEEEEE"><strong>الفرع</strong></td>
                      ...
                      <tr>
                        ...
                        <td width="50%" align="center"><strong>الفرع</strong></td>
                        </tr>
                      <tr>
              ...
              <tr valign="baseline">
                <td colspan="2" align="right" nowrap="nowrap"><h3>
                  <strong>
                    ...
                    <input type="hidden" name="ExpierDate" value="" size="32" />
                  </strong></h3></td>
              </tr>
              <tr valign="baseline">
                <td colspan="2" align="center" nowrap="nowrap"><table id="table">
                  <tr>
                      <th align="center" bgcolor="#EEEEEE"><strong>التاريخ</strong></th>
                      ...
                      <th align="center" bgcolor="#EEEEEE">الفرع</th>
...
<?php
if($row_Recordset9['tamrinatedafia'] <= $row_Recordset8['SUM(curenttamrina)']){
