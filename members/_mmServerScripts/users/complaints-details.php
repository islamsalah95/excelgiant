      ...
      <div class="w3-container w3-card w3-white w3-margin-bottom">
        ...
        <div class="w3-container"><br>
          ...
          <table width="100%" border="0" cellspacing="4" cellpadding="4">
            <tr>
              <td align="left" valign="top"><table border="0" align="center" cellpadding="2" cellspacing="2">
                <tr>
                  <td>تاريخ الشكوى</td>
                  <td valign="top"><?php echo $row_Recordset2['create_date']; ?></td>
                  </tr>
                <tr>
                  <td>تفاصيل الشكوى</td>
                  <td valign="top"><?php echo $row_Recordset2['details']; ?></td>
                  </tr>
              </table></td>
            </tr>
          </table>
