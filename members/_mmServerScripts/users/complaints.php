          ...
          <table width="100%" border="0" cellspacing="4" cellpadding="4">
            <tr>
              <td align="left"><table width="100" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td height="30" align="center" bgcolor="#D9EAF4"><a href="complaints-add.php"><i class="fa fa-plus" aria-hidden="true"></i> إضافة </a></td>
                </tr>
              </table></td>
            </tr>
            <tr>
              <td>
                <table border="1" align="center">
                  <tr bgcolor="#D9EAF4">
                    <td align="center">مقدم الشكوى</td>
                    <td align="center">تاريخ الشكوى</td>
                  ...
                  <?php do { ?>
                    <tr>
                      ...
                      <td align="center"><a href="complaints-details.php?id=<?php echo $row_Recordset2['id']; ?>"><i class="fa fa-external-link" aria-hidden="true"></i></a></td>
                      <td align="center"><a href="complaints-edit.php?id=<?php echo $row_Recordset2['id']; ?>"><i class="fa fa-edit" aria-hidden="true"></i></a></td>
                      <td align="center"><a href="complaints-delete.php?id=<?php echo $row_Recordset2['id']; ?>"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
                    </tr>
