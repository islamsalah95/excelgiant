...
<table width="65%" border="0" align="right" cellpadding="2" cellspacing="2">
  <tr>
    <td><table width="98%" border="0" align="center" cellpadding="1" cellspacing="1" dir="rtl">
      <tr>
        <td height="33" colspan="6" align="center" valign="middle"><h3><strong>عقد اشتراك</strong></h3></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td height="33" colspan="5" align="right" valign="middle"><strong><?php echo $row_RSElbaka['price']; ?></strong></td>
        </tr>
      <tr>
      ...
      <tr>
        ...
        <td width="25%" height="33" colspan="2" align="right" valign="middle"><strong><?php echo $row_RSElbaka['price']; ?></strong></td>
      </tr>
      <tr>
