    ...
    <div class="w3-third">
      ...
      <div class="w3-white w3-text-grey w3-card-4">
        <div class="w3-display-container">
          <img src="/users/photo/<?php echo $row_Recordset1['per_img']; ?>" style="width:100%" alt="Avatar">
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table align="center">
    ...
    <tr valign="baseline">
      <td colspan="2" align="center" nowrap="nowrap"><a href="photo/<?php echo $row_Recordset1['grad_img']; ?>" target="_new"><img src="../photo/<?php echo $row_Recordset1['grad_img']; ?>" alt="" height="220"></a></td>
      </tr>
    <tr valign="baseline">
...
?>
    ...
    <tr valign="baseline">
      <td colspan="2" align="right" nowrap="nowrap">الوظيفة:</td>
      </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      <td colspan="2" align="right" nowrap="nowrap"><select name="member_type" id="member_type">
        ...
        <option value="مميزة" <?php if (!(strcmp("مميزة", $row_Recordset1['member_type']))) {echo "selected=\"selected\"";} ?>>مميزة</option>
      </select></td>
      </tr>
    <tr valign="baseline">
...
?>
    ...
    <tr valign="baseline">
      <td colspan="2" align="right" nowrap="nowrap">الفرع:
...
<footer class="w3-container w3-teal w3-center w3-margin-top">
  <p>جميع الحقوق محفوظة لEnergy Fitness Center 2022</p>
