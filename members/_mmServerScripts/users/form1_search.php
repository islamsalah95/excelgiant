...
$colname_Recordset1 = "عقد اشتراك عضو";
...
if (isset($_GET['saidly_name'])) {
  $colname3_Recordset1 = $_GET['saidly_name'];
}
mysqli_query($connection, $query)($database_connection, $connection);
$query_Recordset1 = sprintf("SELECT * FROM form1 WHERE form_type = %s AND sub_syndicate = %s AND saidly_name LIKE %s ORDER BY id DESC", GetSQLValueString($colname_Recordset1, "text"),GetSQLValueString($colname2_Recordset1, "text"),GetSQLValueString("%" . $colname3_Recordset1 . "%", "text"));
...
<table width="100%" border="0" cellpadding="2" cellspacing="2" dir="rtl">
  ...
  <tr>
    <td><table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
      <tr>
        <td><form id="form1" name="form1" method="get" action="../users/form1_search.php">
          <table border="0" align="center" cellpadding="1" cellspacing="1">
            <tr>
              <td><input name="sub_syndicate" type="hidden" id="sub_syndicate" value="<?php echo $row_Recordset1['sub_syndicate']; ?>" /></td>
              <td><input name="form_type" type="hidden" id="form_type" value="عقد اشتراك عضو" /></td>
              <td>اسم العضو</td>
    ...
    searchBtn.addEventListener("click", function () {
      ...
      const searchResult = window.find(search);
        ...
        <td width="100" height="30" align="center" bgcolor="#D9EAF4"><a href="form1add.php?sub_syndicate=<?php echo $row_Recordset2['sub_syndicate']; ?>" target="_new"><i class="fa fa-plus" aria-hidden="true"></i> إضافة </a></td>
      </tr>
    </table></td>
  </tr>
  <tr>
    <td><table id="myTable" width="95%" border="1" align="center" dir="rtl">
      ...
      <tr>
        ...
        <td width="50" align="center"><a href="form1_print.php?id=<?php echo $row_Recordset1['id']; ?>" target="_new"><i class="fa fa-print" aria-hidden="true"></i></a></td>
        <td width="50" align="center"><a href="form1_edit.php?id=<?php echo $row_Recordset1['id']; ?>" target="_new"><i class="fa fa-edit" aria-hidden="true"></i></a></td>
        <td width="50" align="center"><a href="form1_del.php?id=<?php echo $row_Recordset1['id']; ?>" target="_new"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
        </tr>
...
Records <?php echo ($startRow_Recordset1 + 1) ?> to <?php echo min($startRow_Recordset1 + $maxRows_Recordset1, $totalRows_Recordset1) ?> of <?php echo $totalRows_Recordset1 ?><table border="0" align="center" dir="ltr">
  ...
  <tr>
    <td><table width="100" border="0" align="left" cellpadding="0" cellspacing="0">
      <tr>
        <td height="30" align="center" bgcolor="#D9EAF4"><a href="form1add.php?sub_syndicate=<?php echo $row_Recordset2['sub_syndicate']; ?>" target="_new"><i class="fa fa-plus" aria-hidden="true"></i> إضافة </a></td>
      </tr>
    </table></td>
  </tr>
</table>
