...
<table width="100%" border="0" cellpadding="2" cellspacing="2" dir="rtl">
  <tr>
    <td align="center"><h2><strong>نموذج عقد اشتراك عضو </strong></h2></td>
  </tr>
  <tr>
    <td><hr /></td>
  </tr>
...
?>
  ...
  <tr>
    <td>&nbsp;
      <form action="<?php echo $editFormAction; ?>" method="post" name="form1" class="form" id="form1">
        <?php if ($totalRows_RSMemper > 0) { // Show if recordset not empty ?>
  <table align="center">
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">نوع النموذج:</td>
      <td colspan="2"><input name="form_type" type="text" value="عقد اشتراك عضو" size="32" readonly="readonly" /></td>
      </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right"><span dir="rtl">للعمل&nbsp;</span>:</td>
    ...
    <tr valign="baseline">
      ...
      <td><input name="per_img" type="text" id="per_img" value="<?php echo $row_RSMemper['per_img']; ?>" size="32" readonly="readonly" /></td>
      <td rowspan="4" align="center" valign="top"><img src="../photo/<?php echo $row_RSMemper['per_img']; ?>" width="70" height="100" /></td>
      </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right"><span dir="rtl">عليه يؤذن للعضو&nbsp;</span>:</td>
      <td><input name="saidly_name" type="text" value="<?php echo $row_RSMemper['aname']; ?> <?php echo $row_RSMemper['bname']; ?> <?php echo $row_RSMemper['cname']; ?> <?php echo $row_RSMemper['dname']; ?>" size="32" readonly="readonly" /></td>
      </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right"><span dir="rtl">بمزاولة مهنة الصيدلة&nbsp;بوظيفة</span>:</td>
      <td><input name="job_name" type="text" value="<?php echo $row_RSMemper['member_activity']; ?>" size="32" readonly="readonly" /></td>
      </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right"><span dir="rtl">بـ  اسم النشاط</span>:</td>
      <td><input name="activity_name" type="text" value="<?php echo $row_RSMemper['work_place']; ?>" size="32" readonly="readonly" /></td>
      </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">الكائنة:</td>
      <td colspan="2"><textarea name="text3" id="editor" cols="60" rows="5"></textarea></td>
      </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right"><span dir="rtl">وينتهي صلاحيته ئبتاريخ </span>:</td>
    ...
    <tr valign="baseline">
      ...
      <td colspan="2"><input name="nekaba" type="text" value="<?php echo $row_RSMemper['id']; ?>" size="32" readonly="readonly" /></td>
      </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">يعتمد</td>
      <td colspan="2"><label for="nekaba_name"></label>
        <select name="nekaba_name" id="nekaba_name">
          <?php
do {  
?>
...
?>
    ...
    <tr valign="baseline">
      ...
      <td colspan="2"><input type="text" name="nakeb_name" value="<?php echo $row_rstowns['syndadmin']; ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      ...
      <td colspan="2"><input name="print_date" type="text" value="<?php echo date("Y-m-d h:i:s"); ?>" size="32" readonly="readonly" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">بواسطة:</td>
      <td colspan="2"><input name="print_by" type="text" value="<?php echo $row_Recordset1['first_name']; ?> <?php echo $row_Recordset1['bname']; ?> <?php echo $row_Recordset1['cname']; ?> <?php echo $row_Recordset1['last_name']; ?>" size="32" readonly="readonly" /></td>
      </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      <td nowrap="nowrap" align="right"><label for="sub_syndicate"></label>
        <input name="sub_syndicate" type="hidden" id="sub_syndicate" value="<?php echo $row_RSMemper['sub_syndicate']; ?>" /></td>
