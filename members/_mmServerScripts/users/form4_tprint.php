              ...
              <td><table border="0" align="center" cellpadding="2" cellspacing="2" dir="rtl">
                <tr bgcolor="#FFFFFF">
                  <td align="center" valign="top"><table width="308" border="0" cellspacing="0" cellpadding="0">
                    <tr valign="top">
                      <td width="227"><h3 align="center">
                      Energy Fitness Center</h3>
                        <p>اسم العضو: <strong><?php echo $row_Recordset1['saidly_name']; ?></strong></p>
                        <p>العضوية: <strong><?php echo $row_Recordset1['activity_name']; ?></strong></p>
                        <p>النشاط: <strong><?php echo $row_Recordset1['job_name']; ?></strong></p>
                        <p>الفرع: <strong><?php echo $row_Recordset1['nekaba_name']; ?></strong></p>
                        <p>اسم الدخول: <strong><?php echo $row_Recordset1['text3']; ?></strong></p>
                        <p>رقم العضوية: <strong><?php echo $row_Recordset1['nekaba']; ?></strong></p>
                      ...
                      <td width="70" align="center"><table width="80" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <table width="70" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td height="80" align="center" valign="middle"><strong><img src="https://chart.googleapis.com/chart?chs=300x300&amp;cht=qr&amp;chl=https://sport-tower.com/users/validation.php?id=<?php echo $row_Recordset1['nekaba']; ?>&amp;icon=" alt="Energy Fitness Center" width="65" height="65" border="0" title="Energy Fitness Center"%2F&choe=UTF-8&quot; /></strong></td>
                          </tr>
                        </table></td>
                    </tr>
                  </table></td>
                  ...
                  <td width="227" height="90" valign="top"><table width="80%" border="0" align="right" cellpadding="0" cellspacing="0" dir="rtl">
                    <tr>
                      <td height="40" align="center">
                        <br />
                            <br />
                      </strong><strong>Energy Fitness Center</strong></h2></td>
                    </tr>
                    <tr>
