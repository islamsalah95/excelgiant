...
$query_Recordset1 = "SELECT * FROM form2 ORDER BY id DESC";
          ...
          <tr align="center" valign="top">
            <td colspan="2" align="right"><table border="0" cellspacing="4" cellpadding="4">
              <tr>
                ...
                <td align="right" nowrap="nowrap"><strong style="font-size:21px"><?php echo $row_Recordset1['saidly_name']; ?></strong></td>
                <td align="right" nowrap="nowrap"><strong>رقم العضوية:</strong></td>
                <td align="right" nowrap="nowrap"><strong><strong style="font-size:21px"><?php echo $row_Recordset1['saydly_id']; ?></strong></strong></td>
              </tr>
              <tr>
                <td align="right" nowrap="nowrap"><strong>صاحب ترخيص:</strong></td>
                <td colspan="3" align="right"><strong style="font-size:21px"><?php echo $row_Recordset1['job_name']; ?></strong></td>
                </tr>
              <tr>
                <td align="right" nowrap="nowrap"><strong>بتوظيف السيد: &nbsp;</strong></td>
                <td align="right" nowrap="nowrap"><strong style="font-size:21px"><?php echo $row_Recordset1['mowazafname']; ?></strong></td>
                <td align="right" nowrap="nowrap"><strong>رقم تسلسل: &nbsp;</strong></td>
                <td align="right" nowrap="nowrap"><strong style="font-size:21px"><?php echo $row_Recordset1['id']; ?></strong></td>
              </tr>
              <tr>
                <td align="right" nowrap="nowrap"><strong>ومؤهله: &nbsp;</strong></td>
                <td align="right" nowrap="nowrap"><strong style="font-size:21px"><?php echo $row_Recordset1['mowazafstudy']; ?></strong></td>
                <td align="right" nowrap="nowrap"><strong>لمزاولة مهنة: </strong></td>
                <td align="right" nowrap="nowrap"><strong style="font-size:21px"><?php echo $row_Recordset1['mowazafjob']; ?></strong></td>
              </tr>
            </table></td>
              ...
              <table width="300" align="left" cellpadding="0" cellspacing="0" dir="rtl">
                <tr>
                  <td align="center"><p><strong> يعتمد،<br />
                    <?php echo $row_Recordset1['syndadminjop']; ?><br />
                    <br />
                    <?php echo $row_Recordset1['nakeb_name']; ?> <br />
                  </strong></p></td>
                </tr>
              </table>              <p align="center" dir="rtl">&nbsp;</p></td>
          </tr>
          <tr>
