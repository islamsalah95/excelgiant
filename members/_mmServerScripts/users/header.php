...
$query_ReHeader = sprintf("SELECT * FROM users WHERE username = %s", GetSQLValueString($colname_ReHeader, "text"));
...
<a href="contract_view.php?sub_syndicate=<?php echo $row_ReHeader['sub_syndicate']; ?>">عقد اشتراك</a>
<a href="form4_view.php?sub_syndicate=<?php echo $row_ReHeader['sub_syndicate']; ?>">بطاقة عضوية</a>
<?php } // Show if recordset not empty ?>
