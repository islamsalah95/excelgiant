...
mysqli_query($connection, $query)($database_connection, $connection);
$query_Recordset3 = sprintf("SELECT * FROM city WHERE sub_syndicateid = %s", GetSQLValueString($colname_Recordset3, "int"));
...
?>
          ...
          <tr valign="baseline">
            <td nowrap="nowrap" align="right">الموبايل:
            <input name="sub_syndicate" type="hidden" id="sub_syndicate" value="<?php echo $row_Recordset2['sub_syndicate']; ?>" size="32" /></td>
