        ...
        <table align="center">
          <tr valign="baseline">
            ...
            <td><select name="member_type">
              ...
              <option value="مميزة" <?php if (!(strcmp("مميزة", $row_Recordset3['member_type']))) {echo "selected=\"selected\"";} ?>>مميزة</option>
            </select></td>
          </tr>
          <tr valign="baseline">
...
do {  
?>
              <option value="<?php echo $row_rsuniversity['id']?>"<?php if (!(strcmp($row_rsuniversity['id'], $row_Recordset3['grad_place']))) {echo "selected=\"selected\"";} ?>><?php echo $row_rsuniversity['name']?></option>
              <?php
...
do {  
?>
              <option value="<?php echo $row_Recordset6['towns']?>"><?php echo $row_Recordset6['sybsub_syndicate']; ?> - <?php echo $row_Recordset6['towns']?></option>
              <?php
