...
mysqli_query($connection, $query)($database_connection, $connection);
$query_Recordset1 = sprintf("SELECT * FROM users WHERE sub_syndicate = %s", GetSQLValueString($colname_Recordset1, "text"));
...
<table width="100%" border="0" cellpadding="4" cellspacing="4" dir="rtl">
  <tr>
    <td align="center"><h2><strong>صلاحيات المستخدمين</strong></h2></td>
  </tr>
  <tr>
    <td><hr /></td>
  </tr>
    ...
    <td>&nbsp;
      <?php if ($totalRows_Recordset2 > 0) { // Show if recordset not empty ?>
        <form action="<?php echo $editFormAction; ?>" method="post" name="form2" id="form2">
          <table align="center">
      <tr valign="baseline">
        <td nowrap="nowrap" align="right">المستخدمين:
