...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO requestes (id, requeste_type, details, viewed, create_date, edit_date, create_by, edit_by) VALUES (%s, %s, %s, %s, %s, %s, %s, %s)",
...
mysqli_query($connection, $query)($database_connection, $connection);
$query_Recordset2 = sprintf("SELECT * FROM requestes WHERE create_by = %s", GetSQLValueString($colname_Recordset2, "int"));
...
do {  
?>
                          <option value="<?php echo $row_RecordsetResquestes['name']?>"><?php echo $row_RecordsetResquestes['name']?></option>
                          <?php
...
?>
                    ...
                    <tr valign="baseline">
                      <td nowrap align="right" valign="top">تفاصيل الطلب:</td>
                      <td><textarea name="details" cols="50" rows="10"></textarea></td>
                    </tr>
                    <tr valign="baseline">
                      <td nowrap align="right"><input type="hidden" name="create_date" value="<?php echo date("Y-m-d h:i:s"); ?>" size="32">                        <input type="hidden" name="create_by" value="<?php echo $row_Recordset1['id']; ?>" size="32"></td>
                      <td><input type="submit" value="إضافة"></td>
                    </tr>
                  </table>
                  <input type="hidden" name="id" value="">
                  <input type="hidden" name="viewed" value="">
