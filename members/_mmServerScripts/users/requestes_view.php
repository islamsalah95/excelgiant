...
$query_Recordset1 = sprintf("SELECT * FROM requestes WHERE sub_syndicate = %s ORDER BY id DESC", GetSQLValueString($colname_Recordset1, "int"));
...
<table width="100%" border="0" cellpadding="2" cellspacing="2" dir="rtl">
  <tr>
    <td align="center"><h2><strong>الطلبات</strong></h2></td>
  </tr>
  <tr>
    <td><hr /></td>
  </tr>
...
?>
        ...
        <td><?php echo $row_Recordset1['requeste_type']; ?></td>
...
?>
        ...
        <td><label for="select2"></label>
          <select name="select2" id="select2">
            <option value="0" <?php if (!(strcmp(0, $row_Recordset1['done']))) {echo "selected=\"selected\"";} ?>>لم ينفذ</option>
            <option value="1" <?php if (!(strcmp(1, $row_Recordset1['done']))) {echo "selected=\"selected\"";} ?>>تم التنفيذ</option>
          </select></td>
        <td width="50"><a href="requestes_edit.php?id=<?php echo $row_Recordset1['id']; ?>" target="_new"><i class="fa fa-cog" aria-hidden="true"></i></a></td>
        </tr>
