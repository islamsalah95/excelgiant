    ...
    <td>
      ...
      <table align="center">
        ...
        <tr valign="baseline">
          ...
          <td><input type="text" name="grad_img" value="" size="32" /></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">صورة شخصية:</td>
          <td><input type="text" name="per_img" value="" size="32" /></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">صورة البطاقة:</td>
          <td><input type="text" name="sign_img" value="" size="32" /></td>
        </tr>
        <tr valign="baseline">
