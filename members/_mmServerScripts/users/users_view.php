  ...
  <script type="text/javascript">
    ...
    searchBtn.addEventListener("click", function () {
      ...
      const searchResult = window.find(search);
        ...
        <td height="30" align="center" bgcolor="#D9EAF4"><a href="users_add.php?sub_syndicate=<?php echo $row_Recordset2['sub_syndicate']; ?>"><i class="fa fa-plus" aria-hidden="true"></i> إضافة </a></td>
