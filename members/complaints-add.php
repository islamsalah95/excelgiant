...
<table border="0" align="center" cellpadding="4" cellspacing="4">
  <tr>
    <td align="left"><table width="100%" align="center" cellpadding="4" cellspacing="4">
      <tr>
      ...
      <form method="post" name="form1" action="<?php echo $editFormAction; ?>create_by=<?php echo $row_Recordset1['id']; ?>">
        <table align="center">
          <tr valign="baseline">
            <td nowrap align="right" valign="top">الاسم:</td>
            <td><input type="text" name="create_by"></td>
          </tr>
          <tr valign="baseline">
            <td nowrap align="right" valign="top">رقم الاتصال:</td>
            <td><input type="text" name="edit_by" value=""></td>
          </tr>
          <tr valign="baseline">
            <td nowrap align="right" valign="top">التاريخ</td>
            <td><input type="text" name="create_date" value="<?php echo date("Y-m-d"); ?>"></td>
          </tr>
          <tr valign="baseline">
            <td nowrap align="right" valign="top">الطلب:</td>
            <td><textarea name="details" rows="3" id="details"></textarea></td>
          </tr>
          <tr valign="baseline">
