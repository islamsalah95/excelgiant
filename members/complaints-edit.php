            ...
            <tr>
              <td align="left">&nbsp;
                <form method="post" name="form1" action="<?php echo $editFormAction; ?>create_by=<?php echo $row_Recordset1['id']; ?>">
                  <table align="center">
                    <tr valign="baseline">
                      <td align="right" valign="top" nowrap>الاسم:</td>
                      <td><input type="hidden" name="create_by" value="<?php echo htmlentities($row_Recordset2['create_by'], ENT_COMPAT, 'UTF-8'); ?>" size="32"></td>
                    </tr>
                    <tr valign="baseline">
