...
$query_Recordset1 = sprintf("SELECT * FROM complaints WHERE id = %s ORDER BY id DESC", GetSQLValueString($colname_Recordset1, "int"));
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE complaints SET details=%s, viewed=%s, create_date=%s, edit_date=%s, create_by=%s, edit_by=%s, sub_syndicate=%s, done=%s, requeste_type=%s WHERE id=%s",
  ...
  $updateGoTo = "complaints_view.php?sub_syndicate=". $row_Recordset1['sub_syndicate'] . "";
  if (isset($_SERVER['QUERY_STRING'])) {
      ...
      <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
        <table align="center">
          <tr valign="baseline">
            ...
            <td><select name="done">
              <option value="0">لم تعرض</option>
              <option value="1">تم العرض</option>
            </select></td>
          </tr>
          <tr valign="baseline">
