...
$query_Recordset1 = sprintf("SELECT * FROM contract WHERE tarekh = %s ORDER BY id DESC", GetSQLValueString($colname_Recordset1, "text"));
...
<table width="100%" cellspacing="2" cellpadding="2">
  <tr align="center">
    <td><table width="100%" align="center" cellpadding="6" cellspacing="6">
      <tr>
        ...
        <td width="25%" align="center" bgcolor="#82B3D8"><a href="contract3.php"><strong>إيرادات يوم</strong></a></td>
      </tr>
    </table></td>
  </tr>
  <tr>
    <td align="center"><h1>إيرادات يوم</h1></td>
  </tr>
  <tr>
    <td><form method="get">
