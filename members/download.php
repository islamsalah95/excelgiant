  ...
  <tr>
    <td><table id="myTable" width="95%" border="1" align="center" dir="rtl">
        <tr bgcolor="#7470B3">
          ...
          <th width="50" align="center" nowrap="nowrap">تحميل</th>
        </tr>
        <?php do { ?>
          <tr align="center">
            <td><p><?php echo $row_Recordset1['name']; ?> </p></td>
            <td width="100"><?php echo $row_Recordset1['syndadmin']; ?></td>
            <td width="50"><a href="https://new.excelgiants.site/download.php?id=<?php echo $row_Recordset1['id']; ?>" target="_new"><i class="fa fa-download" aria-hidden="true"></i></a></td>
          </tr>
