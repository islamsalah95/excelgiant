...
<meta name="description" content="طلب تجديد عضوية حالية">
...
<table width="100%" border="0" cellpadding="2" cellspacing="2" dir="rtl">
  ...
  <tr>
    <td align="center"><h2><strong>استمارة تجديد عضوية</strong></h2></td>
  </tr>
    <tr>
    <td><hr /></td>
  </tr>
...
<form action="<?php echo $editFormAction; ?>" method="post" enctype = "multipart/form-data" name="form1" id="form1">
  <table align="center" dir="rtl">
    ...
    <tr valign="baseline">
      <td>
        <input type="text" name="NID" value="" size="32" placeholder="الرقم القومي:" required/>
      </td>
    </tr>
    <tr valign="baseline">
      <td>
    ...
    <tr valign="baseline">
      <td><input name="Qualification" type="text" required="required" id="Qualification" placeholder="المؤهل:" value="" size="32"/></td>
    </tr>
    <tr valign="baseline">
      <td>
        <input type="text" name="Jop" value="" size="32" placeholder="الوظيفة:" required/>
      </td>
    </tr>
    <tr valign="baseline">
      <td><input name="Address2" type="text" disabled="disabled" required="required" placeholder="اسم الشارع او القرية:" value="محافظة كفرالشيخ، مركز بيلا" size="32" readonly="readonly"/></td>
    </tr>
    <tr valign="baseline">
      <td><input name="Address" type="text" value="" size="32" placeholder="اسم الشارع او القرية:" required/></td>
    </tr>
    <tr valign="baseline">
      <td><input type="text" name="MemberID" value=""  placeholder="رقم العضوية:" required/></td>
    </tr>
    <tr valign="baseline">
  ...
  <input type="hidden" name="Status" value="تجديد عضوية حالية" />
