...
if (!function_exists("GetSQLValueString")) {
  function GetSQLValueString($theValue, $theType, $theDefinedValue = "", $theNotDefinedValue = "") {
    ...
    // No need for magic quotes handling in PHP 7+, so we simply escape:
...
if (isset($_POST[$MM_flag])) {
  ...
  // No need to call mysqli_query($connection, $query)() when using MySQLi and a connection file that already selects the database
  $LoginRS = mysqli_query($connection, $LoginRS__query) or die(mysqli_error($connection));
  $loginFoundUser = mysqli_num_rows($LoginRS);

  // If a row exists, the username was found - cannot add the requested username
  if ($loginFoundUser) {
    $MM_qsChar = "?";
...
<form action="<?php echo $editFormAction; ?>" method="post" enctype = "multipart/form-data" name="form1" id="form1">
  <table align="center" dir="rtl">
    ...
    <tr valign="baseline">
      <td>
        <input type="text" name="NID" value="" size="32" placeholder="اسم المستخدم:"  required/>
      </td>
    </tr>
    <tr valign="baseline">
      <td><input name="Qualification" type="text" id="Qualification" placeholder="كلمة المرور:" value="" size="32"  required/></td>
    </tr>
    <tr valign="baseline">
      <td><input type="text" name="Jop" value="" size="32" placeholder="كود الدولة:"  required/></td>
    </tr>
    <tr valign="baseline">
      <td>
    ...
    <tr valign="baseline">
      <td><input name="Address" type="text" value="" size="32" placeholder="الدولة:"  required/></td>
    </tr>
    ...
    <tr valign="baseline">
      <td align="center"><input type="submit" class="button button2" value="تسجيل" /></td>
    </tr>
  </table>
