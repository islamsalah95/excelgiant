...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE activates SET name=%s, create_date=%s, edit_date=%s, create_by=%s, edit_by=%s WHERE id=%s",
...
mysqli_query($connection, $query)($database_connection, $connection);
$query_Recordset1 = sprintf("SELECT * FROM activates WHERE id = %s ORDER BY id ASC", GetSQLValueString($colname_Recordset1, "int"));
