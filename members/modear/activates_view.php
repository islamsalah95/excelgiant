...
mysqli_query($connection, $query)($database_connection, $connection);
$query_Recordset1 = "SELECT * FROM activates ORDER BY id ASC";
...
<table width="100%" border="0" cellpadding="2" cellspacing="2" dir="rtl">
  <tr>
    <td align="center"><h2><strong>الانشطة</strong></h2></td>
  </tr>
  <tr>
    <td><hr /></td>
  </tr>
  ...
  <script type="text/javascript">
    ...
    searchBtn.addEventListener("click", function () {
      ...
      const searchResult = window.find(search);
        ...
        <td height="30" align="center" bgcolor="#D9EAF4"><a href="activates_add.php"><i class="fa fa-plus" aria-hidden="true"></i> إضافة </a></td>
    ...
    <td><table id="myTable" width="95%" border="1" align="center" dir="rtl">
        ...
        <?php do { ?>
          <tr align="center">
            ...
            <td width="50"><a href="activates_edit.php?id=<?php echo $row_Recordset1['id']; ?>" target="_new"><i class="fa fa-edit" aria-hidden="true"></i></a></td>
            <td width="50"><a href="activates_delete.php?id=<?php echo $row_Recordset1['id']; ?>" target="_new"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
          </tr>
