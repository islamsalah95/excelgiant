...
$colname2_Recordset1 = "Group Fitness";
if (isset($_GET['ElKesm'])) {
  $colname2_Recordset1 = $_GET['ElKesm'];
}
mysqli_query($connection, $query)($database_connection, $connection);
$query_Recordset1 = sprintf("SELECT * FROM contract WHERE Elodw = %s AND ElKesm = %s", GetSQLValueString($colname_Recordset1, "text"),GetSQLValueString($colname2_Recordset1, "text"));
...
mysqli_query($connection, $query)($database_connection, $connection);
$query_rsclassatfinal = "SELECT * FROM classatattend ORDER BY id DESC";
$rsclassatfinal = mysqli_query($connection,$query_rsclassatfinal) or die(mysqli_error($connection));
$row_rsclassatfinal = mysqli_fetch_assoc($rsclassatfinal);
$totalRows_rsclassatfinal = mysqli_num_rows($rsclassatfinal);
                  ...
                  <tr>
                    <td><table width="100%" align="center">
                      <tr>
                        ...
                        <td rowspan="2" align="center"><input type="submit"  id="Button" class="w3-btn w3-blue" value="حضور" /></td>
                      </tr>
                      <tr>
                        <td colspan="2" align="center"><label for=""></label>
                          <label for="classat"></label>
                          <input name="classat" type="hidden" id="classat" value="<?php echo $row_rsclassatfinal['classat']; ?>" />
                          <label for=""></label>
                          <?php $row_Recordset3['ElFara'] ?>
                          <label for="Faraa"></label>
                          <input name="Faraa" type="hidden" id="Faraa" value="<?php echo $row_rsclassatfinal['Faraa']; ?>" /></td>
                      </tr>
                      </table></td>
                  </tr>
                </table></td>
...
?>
                    ...
                    <input type="hidden" name="Trainer" value="<?php echo $row_rsclassatfinal['trainer']; ?>" size="32" />
  ...
  <table id="table">
    ...
    <?php do { ?>
      <tr>
        ...
        <td><?php echo $row_Recordset6['classat']; ?></td>
        <td><?php echo $row_Recordset6['Trainer']; ?></td>
        ...
        <td align="center"><a href="attend_fitness_del.php?id=<?php echo $row_Recordset6['id']; ?>"><strong>حذف</strong></a></td>
      </tr>
...
mysqli_free_result($rsclassatfinal);
