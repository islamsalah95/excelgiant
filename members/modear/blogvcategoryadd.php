...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO blogvides (id, title, image, samary, category, topic, tdate, tauther) VALUES (%s, %s, %s, %s, %s, %s, %s, %s)",
  ...
  $insertGoTo = "blogvcategoryview.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<form action="<?php echo $editFormAction; ?>" method="post" enctype="multipart/form-data" name="form1" id="form1">
  ...
  <table width="60%" align="center" dir="rtl">
    ...
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">نص المقال:</td>
      <td>&nbsp;</td>
    </tr>
    <tr valign="baseline">
