...
$query_Recordset1 = "SELECT * FROM blogvides ORDER BY id DESC";
...
<table width="100%" border="0" cellpadding="2" cellspacing="2" dir="rtl">
  <tr>
    <td align="center"><h2><strong>المكتبة المرئية</strong></h2></td>
  </tr>
  <tr>
    <td><hr /></td>
  </tr>
  <tr>
    ...
    searchBtn.addEventListener("click", function () {
      ...
      const searchResult = window.find(search);
        ...
        <td height="30" align="center" bgcolor="#D9EAF4"><a href="blogvcategoryadd.php"><i class="fa fa-plus" aria-hidden="true"></i> إضافة </a></td>
      </tr>
    </table></td>
  </tr>
  <tr>
    <td><table width="95%" border="1" align="center" id="myTable">
        <tr>
          ...
          <th align="center" bgcolor="#7470b3">عنوان المقال</th>
          <th align="center" bgcolor="#7470b3">صورة المقال</th>
          <th align="center" bgcolor="#7470b3">ملخص المقال</th>
        ...
        <?php do { ?>
          <tr>
            ...
            <td width="50" align="center"><a href="blogvcategoryedit.php?id=<?php echo $row_Recordset1['id']; ?>" target="_new"><i class="fa fa-edit" aria-hidden="true"></i></a></td>
            <td width="50" align="center"><a href="blogvcategorydelete.php?id=<?php echo $row_Recordset1['id']; ?>" target="_new"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
          </tr>
