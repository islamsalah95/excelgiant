...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO classat (id, name, syndadmin, syndadminjop, address, create_date, edit_date, create_by, edit_by) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)",
      ...
      <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
        <table align="center">
          ...
          <tr valign="baseline">
            ...
            <td><label for="syndadmin"></label>
              <select name="syndadmin" id="syndadmin">
                <?php
do {  
?>
