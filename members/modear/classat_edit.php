...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE classat SET name=%s, syndadmin=%s, syndadminjop=%s, address=%s, create_date=%s, edit_date=%s, create_by=%s, edit_by=%s WHERE id=%s",
...
mysqli_query($connection, $query)($database_connection, $connection);
$query_Recordset1 = sprintf("SELECT * FROM classat WHERE id = %s ORDER BY id ASC", GetSQLValueString($colname_Recordset1, "int"));
...
<table width="100%" border="0" cellpadding="2" cellspacing="2" dir="rtl">
  <tr>
    <td align="center"><h2><strong>الكلاسات</strong></h2></td>
  </tr>
  <tr>
    <td><hr /></td>
  </tr>
  ...
  <tr>
    <td>&nbsp;
      <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
        <table align="center">
          <tr valign="baseline">
            <td nowrap="nowrap" align="right">اسم الكلاس:</td>
          ...
          <tr valign="baseline">
            ...
            <td><select name="syndadmin" id="syndadmin">
              <?php
do {  
?>
              <option value="<?php echo $row_Recordset2['username']?>"<?php if (!(strcmp($row_Recordset2['username'], $row_Recordset1['syndadmin']))) {echo "selected=\"selected\"";} ?>><?php echo $row_Recordset2['username']?></option>
              <?php
