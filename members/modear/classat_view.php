...
mysqli_query($connection, $query)($database_connection, $connection);
$query_Recordset1 = "SELECT * FROM classat ORDER BY id ASC";
...
<table width="100%" border="0" cellpadding="2" cellspacing="2" dir="rtl">
  ...
  <script type="text/javascript">
    ...
    searchBtn.addEventListener("click", function () {
      ...
      const searchResult = window.find(search);
        ...
        <td height="30" align="center" bgcolor="#D9EAF4"><a href="classat_add.php"><i class="fa fa-plus" aria-hidden="true"></i> إضافة </a></td>
  ...
  <tr>
    <td><table id="myTable" width="95%" border="1" align="center" dir="rtl">
        <tr bgcolor="#7470B3">
          <th nowrap="nowrap"><strong>اسم الكلاس</strong></th>
          <th width="100" nowrap="nowrap">المدرب</th>
        ...
        <?php do { ?>
          <tr align="center">
            ...
            <td width="50"><a href="classat_edit.php?id=<?php echo $row_Recordset1['id']; ?>" target="_new"><i class="fa fa-edit" aria-hidden="true"></i></a></td>
          </tr>
