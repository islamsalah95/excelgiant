...
$query_Recordset1 = sprintf("SELECT * FROM contract WHERE tarekh BETWEEN %s AND %s ORDER BY id DESC", GetSQLValueString($colname_Recordset1, "text"),GetSQLValueString($colname2_Recordset1, "text"));
...
<table width="100%" cellspacing="2" cellpadding="2">
  <tr>
    <td align="center"><table width="100%" align="center" cellpadding="6" cellspacing="6">
      <tr>
        <td width="25%" align="center" bgcolor="#82B3D8"><strong><a href="contract5.php">إيرادات فترة محددة</a></strong></td>
        <td width="25%" align="center" bgcolor="#AFD4F1"><a href="contract4.php"><strong>إيرادات عام</strong></a></td>
        <td width="25%" align="center" bgcolor="#afd4f1"><strong><a href="contract2.php">إيرادات شهر</a></strong></td>
        <td width="25%" align="center" bgcolor="#afd4f1"><a href="contract3.php"><strong>إيرادات يوم</strong></a></td>
      </tr>
    </table></td>
  </tr>
  <tr>
    <td align="center"><h1>ايرادات فترة محددة</h1></td>
  </tr>
  <tr>
    <td><form method="get">
