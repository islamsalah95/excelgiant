...
mysqli_query($connection, $query)($database_connection, $connection);
$query_RSElodw = "SELECT * FROM members ORDER BY aname ASC";
...
mysqli_query($connection, $query)($database_connection, $connection);
$query_Recordset1 = "SELECT * FROM university";
...
do {  
?>
              <option value="<?php echo $row_RSElodw['id']?>"><?php echo $row_RSElodw['aname']?></option>
              <?php
...
?>
          ...
          <tr valign="baseline">
            <td width="100" align="right" nowrap="nowrap">تاريخ التعاقد:</td>
          ...
          <tr valign="baseline">
            ...
            <td width="200"><strong><?php echo $row_RSElbaka['name']; ?>              
              <input name="Elbaka" type="hidden" id="Elbaka" value="<?php echo $row_RSElbaka['id']; ?>-<?php echo date("Y-m-d") ;?>" />
            </strong></td>
          </tr>
          <tr valign="baseline">
