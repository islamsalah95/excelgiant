...
$MM_restrictGoTo = "../loginmadmin.php";
...
mysqli_query($connection, $query)($database_connection, $connection);
$query_RSAdmin = sprintf("SELECT * FROM modear WHERE id = %s", GetSQLValueString($colname_RSAdmin, "int"));
...
<table width="65%" border="0" align="right" cellpadding="2" cellspacing="2">
  <tr>
    <td><table width="98%" border="0" align="center" cellpadding="1" cellspacing="1" dir="rtl">
      <tr>
        <td height="33" colspan="6" align="center" valign="middle"><h3><strong>استمارة عضوية</strong></h3></td>
      </tr>
      <tr>
        <td height="33" colspan="6" align="right" valign="middle" nowrap="nowrap"><table width="100%" border="0" cellspacing="2" cellpadding="2">
          <tr>
            <td width="25%"><strong>الوحدة الحزبية:</strong></td>
            <td width="25%"><strong><?php echo $row_RSElFara['name']; ?></strong></td>
            <td width="25%"><strong>موظف الوحدة الحزبية:</strong></td>
          ...
          <tr>
            <td width="25%"><strong>تاريخ العضوية:</strong></td>
            <td width="25%"><strong><?php echo $row_RSElodw['create_date']; ?></strong></td>
            <td width="25%"><strong>تاريخ التعاقد:</strong></td>
            <td width="25%"><strong><?php echo $row_RSContract['tarekh']; ?></strong></td>
            </tr>
          </table></td>
      </tr>
      <tr bgcolor="#CCCCCC">
        <td height="33" colspan="6" align="right" valign="middle" bgcolor="#EEEEEE"><strong><img src="bp.png" width="20" />بيانات العضو</strong></td>
      </tr>
      <tr>
        <td width="25%" height="33" align="right" valign="middle" nowrap="nowrap">&nbsp;&nbsp;&nbsp;<strong>اسم العضو: </strong></td>
        <td height="33" colspan="5" align="right" valign="middle" nowrap="nowrap"><strong><?php echo $row_RSElodw['aname']; ?> <?php echo $row_RSElodw['bname']; ?> <?php echo $row_RSElodw['cname']; ?> <?php echo $row_RSElodw['dname']; ?></strong></td>
      </tr>
      <tr>
        <td height="33" align="right" valign="middle" nowrap="nowrap">&nbsp;&nbsp;&nbsp;<strong>رقم الموبايل:</strong></td>
        <td height="33" colspan="5" align="right" valign="middle"><strong><?php echo $row_RSElodw['mobile']; ?></strong></td>
      </tr>
      <tr>
        <td height="33" align="right" valign="middle" nowrap="nowrap">&nbsp;&nbsp;&nbsp;<strong>رقم التليفون:</strong></td>
        <td height="33" colspan="5" align="right" valign="middle"><strong><?php echo $row_RSElodw['phone']; ?></strong></td>
      </tr>
      <tr bgcolor="#CCCCCC">
        <td height="33" colspan="6" align="right" valign="middle" bgcolor="#EEEEEE"><strong><img src="bp.png" alt="" width="20" />تفاصيل الباقة</strong></td>
      </tr>
      <tr>
        <td height="33" align="right" valign="middle" nowrap="nowrap">&nbsp;&nbsp;&nbsp;<strong> العمل العام:</strong></td>
        <td height="33" colspan="5" align="right" valign="middle"><strong><?php echo $row_RSElbaka['section']; ?></strong></td>
      </tr>
      <tr>
        <td height="33" align="right" valign="middle" nowrap="nowrap">&nbsp;&nbsp;&nbsp;<strong> الباقة:</strong></td>
        <td height="33" colspan="5" align="right" valign="middle"><strong><?php echo $row_RSElbaka['name']; ?></strong></td>
      </tr>
      <tr>
        <td height="33" align="right" valign="middle" nowrap="nowrap">&nbsp;&nbsp;&nbsp;<strong>اسم المدرب:</strong></td>
        <td height="33" colspan="5" align="right" valign="middle"><strong><?php echo $row_RSContract['Elmodareb']; ?></strong></td>
      </tr>
      <tr>
        <td height="33" align="right" valign="middle" nowrap="nowrap">&nbsp;&nbsp;&nbsp;<strong>وصف الباقة:</strong></td>
        <td height="33" colspan="5" align="right" valign="middle"><strong><?php echo $row_RSElbaka['description']; ?></strong></td>
      </tr>
      <tr>
        <td height="33" align="right" valign="middle" nowrap="nowrap">&nbsp;&nbsp;&nbsp;<strong>عدد التمرينات:</strong></td>
        <td height="33" colspan="5" align="right" valign="middle"><strong><?php echo $row_RSContract['tamrinatedafia']; ?></strong></td>
        </tr>
      <tr>
        <td height="33" align="right" valign="middle" nowrap="nowrap">&nbsp;&nbsp;&nbsp;<strong>المدة:</strong></td>
        <td height="33" colspan="5" align="right" valign="middle"><strong><?php echo $row_RSElbaka['duration']; ?></strong></td>
        </tr>
      <tr>
        <td height="33" align="right" valign="middle" nowrap="nowrap">&nbsp;&nbsp;&nbsp;<strong>فترة الايقاف:</strong></td>
        <td height="33" colspan="5" align="right" valign="middle"><strong><?php echo $row_RSElbaka['durationstop']; ?></strong></td>
        </tr>
      <tr>
        <td height="33" align="right" valign="middle" nowrap="nowrap">&nbsp;&nbsp;&nbsp;<strong>السعر:</strong></td>
        <td height="33" colspan="5" align="right" valign="middle"><strong><?php echo $row_RSContract['Total']; ?></strong></td>
        </tr>
      <tr>
        <td height="33" align="right" valign="middle" nowrap="nowrap">&nbsp;&nbsp;&nbsp;<strong>ملاحظات:</strong></td>
        <td height="33" colspan="5" align="right" valign="middle"><strong><?php echo $row_RSElbaka['other']; ?></strong></td>
        </tr>
      <tr>
        ...
        <td width="25%" height="33" colspan="2" align="right" valign="middle" nowrap="nowrap"><strong>المبلغ الاجمالي:</strong></td>
        <td width="25%" height="33" colspan="2" align="right" valign="middle"><strong><?php echo $row_RSContract['Total']; ?></strong></td>
      </tr>
      <tr>
        <td height="33" colspan="2" align="right" valign="middle" nowrap="nowrap"><strong>المدفوع:</strong></td>
        <td height="33" colspan="2" align="right" valign="middle"><strong><?php echo $row_RSContract['Madfoaa']; ?></strong></td>
      </tr>
      <tr>
        <td height="33" colspan="2" align="right" valign="middle" nowrap="nowrap"><strong>المتبقى:</strong></td>
        <td height="33" colspan="2" align="right" valign="middle"><strong><?php echo $row_RSContract['Bakey']; ?></strong></td>
      </tr>
      <tr>
