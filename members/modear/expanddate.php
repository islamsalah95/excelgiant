...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form2")) {
  $updateSQL = sprintf("UPDATE attend SET Tarekh=%s, Faraa=%s, `Section`=%s, Baka=%s, Elbaka=%s, classat=%s, curenttamrina=%s, CurrentTamrina=%s, TafeelDate=%s, MemberName=%s, MemberId=%s, Trainer=%s, ExpierDate=%s, Notes=%s WHERE id=%s",
                       GetSQLValueString($_POST['Tarekh'], "text"),
                       GetSQLValueString($_POST['Faraa'], "text"),
                       GetSQLValueString($_POST['Section'], "text"),
                       GetSQLValueString($_POST['Baka'], "text"),
              ...
              <tr valign="baseline">
                <td colspan="2" align="right" nowrap="nowrap"><h3>
                  <strong>
                    ...
                    <input name="ExpierDate" type="hidden" value=
                    "<?php echo $row_Recordset13['ExpierDate']; ?>" size="32" />
                  </strong></h3></td>
              </tr>
              <tr valign="baseline">
                <td colspan="2" align="center" nowrap="nowrap"><table id="table">
                  <tr>
      ...
      <tr>
        <td bgcolor="#9DBFD4">&nbsp;
          <form action="<?php echo $editFormAction; ?>" method="post" name="form2" id="form2">
            <table align="center">
              <tr valign="baseline">
                <td nowrap="nowrap" align="right">إضافة مدة</td>
                <td><input type="date" name="ExpierDate" value="<?php echo htmlentities($row_Recordset13['ExpierDate'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
              </tr>
              <tr valign="baseline">
            ...
            <input type="hidden" name="id" value="<?php echo $row_Recordset13['id']; ?>" />
            <input type="hidden" name="Tarekh" value="<?php echo htmlentities($row_Recordset13['Tarekh'], ENT_COMPAT, 'utf-8'); ?>" />
            <input type="hidden" name="Faraa" value="<?php echo htmlentities($row_Recordset13['Faraa'], ENT_COMPAT, 'utf-8'); ?>" />
            <input type="hidden" name="Section" value="<?php echo htmlentities($row_Recordset13['Section'], ENT_COMPAT, 'utf-8'); ?>" />
            <input type="hidden" name="Baka" value="<?php echo htmlentities($row_Recordset13['Baka'], ENT_COMPAT, 'utf-8'); ?>" />
            <input type="hidden" name="Elbaka" value="<?php echo htmlentities($row_Recordset13['Elbaka'], ENT_COMPAT, 'utf-8'); ?>" />
            <input type="hidden" name="classat" value="<?php echo htmlentities($row_Recordset13['classat'], ENT_COMPAT, 'utf-8'); ?>" />
            <input type="hidden" name="curenttamrina" value="<?php echo htmlentities($row_Recordset13['curenttamrina'], ENT_COMPAT, 'utf-8'); ?>" />
            <input type="hidden" name="CurrentTamrina" value="<?php echo htmlentities($row_Recordset13['CurrentTamrina'], ENT_COMPAT, 'utf-8'); ?>" />
            <input type="hidden" name="TafeelDate" value="<?php echo htmlentities($row_Recordset13['TafeelDate'], ENT_COMPAT, 'utf-8'); ?>" />
            <input type="hidden" name="MemberName" value="<?php echo htmlentities($row_Recordset13['MemberName'], ENT_COMPAT, 'utf-8'); ?>" />
            <input type="hidden" name="MemberId" value="<?php echo htmlentities($row_Recordset13['MemberId'], ENT_COMPAT, 'utf-8'); ?>" />
            <input type="hidden" name="Trainer" value="<?php echo htmlentities($row_Recordset13['Trainer'], ENT_COMPAT, 'utf-8'); ?>" />
            <input type="hidden" name="Notes" value="<?php echo htmlentities($row_Recordset13['Notes'], ENT_COMPAT, 'utf-8'); ?>" />
