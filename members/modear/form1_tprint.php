        ...
        <td><table width="100%" border="0" cellpadding="2" cellspacing="2">
          ...
          <tr>
            <td colspan="3" valign="top"><p><span dir="rtl">عليه يؤذن للعضو&nbsp;:</span><strong><span dir="rtl"> <?php echo $row_Recordset1['saidly_name']; ?><br />
              ...
              <p>وينتهي  صلاحيته بتاريخ : <strong><?php echo $row_Recordset1['exp_date']; ?> </strong> وأن رقم قيده بالوحدة الحزبية العامة  للصيادلة :<strong>&nbsp;<?php echo $row_Recordset1['nekaba']; ?>، وقد تم دفع الرسوم بالسند رقم <?php echo $row_Recordset1['sanad_id']; ?>.<br />
