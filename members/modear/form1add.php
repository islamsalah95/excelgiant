...
<table width="100%" border="0" cellpadding="2" cellspacing="2" dir="rtl">
  <tr>
    <td align="center"><h2><strong>نموذج استمارة عضوية عضو </strong></h2></td>
  </tr>
  <tr>
    <td><hr /></td>
  </tr>
...
?>
  ...
  <table align="center">
    <tr valign="baseline">
      ...
      <td colspan="2"><input name="form_type" type="text" value="استمارة عضوية عضو" size="32" readonly="readonly" /></td>
      </tr>
    <tr valign="baseline">
...
?></td>
    ...
    <tr valign="baseline">
      <td nowrap="nowrap" align="right"><span dir="rtl">وأن رقم قيده بالوحدة الحزبية العامة للصيادلة </span>:</td>
