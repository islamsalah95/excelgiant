...
if (isset($_GET['nekaba'])) {
  $colname2_Recordset1 = $_GET['nekaba'];
}
mysqli_query($connection, $query)($database_connection, $connection);
$query_Recordset1 = sprintf("SELECT * FROM form1 WHERE form_type = %s AND nekaba LIKE %s ORDER BY id DESC", GetSQLValueString($colname_Recordset1, "text"),GetSQLValueString("%" . $colname2_Recordset1 . "%", "text"));
