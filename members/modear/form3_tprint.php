...
<table border="0" align="center" cellpadding="4" cellspacing="4" dir="rtl">
  <tr>
    ...
    <td align="center">&nbsp;</td>
    <td align="center"><a href="form3_fprint.php">
      <button>طباعة</button>
    </a></td>
  </tr>
</table>
        ...
        <td><table width="100%" border="0" cellpadding="2" cellspacing="2">
          <tr align="center" valign="top">
            <td width="100"><table width="130" border="1" cellspacing="0" cellpadding="0">
              <tr>
                <td height="130"><strong><img src="https://chart.googleapis.com/chart?chs=300x300&amp;cht=qr&amp;chl=https://sport-tower.com/users/validation.php?id=<?php echo $row_Recordset1['nekaba']; ?>&amp;icon=" alt="اكسيل للحلول البرمجية" width="130" height="130" border="0" title="اكسيل للحلول البرمجية"%2F&choe=UTF-8&quot; /></strong></td>
              </tr>
            </table></td>
          ...
          <tr>
            <td colspan="3" valign="top"><p><span dir="rtl">عليه يؤذن للعضو&nbsp;:</span><strong><span dir="rtl"> <?php echo $row_Recordset1['saidly_name']; ?><br />
              </span></strong><span dir="rtl">إذن فتح :</span><strong> <?php echo $row_Recordset1['job_name']; ?><br />
                </strong></p>
              <table width="100%" align="center" cellpadding="2" cellspacing="2">
                <tr>
                  <td width="100" align="left"><p>يحمل صفة: &nbsp;</p></td>
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td align="center"><p><strong><?php echo $row_Recordset1['activity_name']; ?></strong></p></td>
                      </tr>
                    </table></td>
                  </tr>
                <tr>
                  <td width="100" align="left"><p>الكائنة: &nbsp;</p></td>
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td align="center"><p><strong><?php echo $row_Recordset1['text3']; ?></strong></p></td>
                      </tr>
                    </table></td>
                  </tr>
                </table>
              <p>وينتهي  صلاحيته بتاريخ : <strong><?php echo $row_Recordset1['exp_date']; ?> </strong> وأن رقم قيده بالوحدة الحزبية العامة  للصيادلة :<strong>&nbsp;<?php echo $row_Recordset1['nekaba']; ?>، وقد تم دفع الرسوم بسند رقم <?php echo $row_Recordset1['sanad_id']; ?>.<br />
