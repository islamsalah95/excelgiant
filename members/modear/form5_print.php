        ...
        <td><table width="100%" border="0" cellpadding="2" cellspacing="2">
          <tr align="center" valign="top">
            <td width="100"><table width="130" border="1" cellspacing="0" cellpadding="0">
              <tr>
                <td height="130"><strong><img src="https://chart.googleapis.com/chart?chs=300x300&amp;cht=qr&amp;chl=https://sport-tower.com/modear/validationm.php?id=<?php echo $row_Recordset1['id']; ?>&amp;icon=" alt="اكسيل للحلول البرمجية" width="130" height="130" border="0" title="اكسيل للحلول البرمجية"%2F&choe=UTF-8&quot; /></strong></td>
              </tr>
            </table></td>
