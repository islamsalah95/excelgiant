...
if (isset($_GET['mowazafname'])) {
  $colname2_Recordset1 = $_GET['mowazafname'];
}
mysqli_query($connection, $query)($database_connection, $connection);
$query_Recordset1 = sprintf("SELECT * FROM form2 WHERE form_type = %s AND mowazafname LIKE %s ORDER BY id DESC", GetSQLValueString($colname_Recordset1, "text"),GetSQLValueString("%" . $colname2_Recordset1 . "%", "text"));
...
<table width="100%" border="0" cellpadding="2" cellspacing="2" dir="rtl">
  ...
  <tr>
    <td><table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
      <tr>
        <td height="30"><form id="form1" name="form1" method="get" action="../modear/form5_searchn.php">
      ...
      <tr>
        <td height="30"><form id="form1" name="form1" method="get" action="../modear/form5_search.php">
          <table border="0" align="center" cellpadding="1" cellspacing="1">
            <tr>
              <td><input name="form_type" type="hidden" id="form_type" value="إذن توظيف بمنشأة صيدلانية" /></td>
              <td>اسم الموظف</td>
