...
if (isset($_GET['id'])) {
  $colname2_Recordset1 = $_GET['id'];
}
mysqli_query($connection, $query)($database_connection, $connection);
$query_Recordset1 = sprintf("SELECT * FROM form2 WHERE form_type = %s AND id LIKE %s ORDER BY id DESC", GetSQLValueString($colname_Recordset1, "text"),GetSQLValueString("%" . $colname2_Recordset1 . "%", "text"));
