...
$query_ReHeader = sprintf("SELECT * FROM modear WHERE username = %s", GetSQLValueString($colname_ReHeader, "text"));
...
<div class="topnav" id="myTopnav" style="">
  ...
  <a href="account.php?username=<?php echo $_SESSION['MM_Username'] ?>"><i class="fa fa-user" aria-hidden="true"></i> حسابي </a>
  <a href="sadmin_edit.php?username=<?php echo $_SESSION['MM_Username'] ?>"><i class="fa fa-user" aria-hidden="true"></i> تعديل </a>
  <a href="changepassword.php?username=<?php echo $_SESSION['MM_Username'] ?>"><i class="fa fa-lock" aria-hidden="true"></i> تغيير كلمة المرور </a>
  <a href="javascript:void(0);" style="font-size:15px;" class="icon" onClick="myFunction()">&#9776;</a>
  <a href="<?php echo $logoutAction ?>"><i class="fa fa-sign-out"></i> خروج </a>
  <div>
    <p align="center">اكسيل للحلول البرمجية - مرحباً يا : <?php echo $_SESSION['MM_Username'] ?> - <strong><?php echo $row_ReHeader['first_name']; ?></strong> <strong><?php echo $row_ReHeader['bname']; ?></strong> <strong><?php echo $row_ReHeader['cname']; ?></strong> <strong><?php echo $row_ReHeader['last_name']; ?></strong></p>
...
<div class="w3-container w3-card w3-white w3-margin-bottom" style="background-image: linear-gradient(WHITE, WHITE,  WHITE,  WHITE,  WHITE,  WHITE, gray);">
  ...
  <tr>
    ...
    <td rowspan="2" align="center" valign="top"><p><img src="../lo.png" width="150"><br>
    </p>
...
<a href="searches.php">البحث</a>
      ...
      <a href="#"> <img src="1.jpg" alt=""/> <span class="sdt_active"></span> <span class="sdt_wrap"> <span class="sdt_link">خصائص</span> <span class="sdt_descr"></span></span></a>
        ...
        <div class="sdt_box"> 
            ...
            <a href="towns_view.php">الوحدات الحزبية</a>
            <a href="banks_view.php">الاقسام</a>
            <a href="university_view.php">الباقات</a>
            <a href="classat_view.php">الكلاسات</a>
...
<a href="contract_view.php">استمارة عضوية</a>
...
<a href="requestes_view.php">الطلبات</a>
        
        
        
        
        
<a href="complaints_view.php">الشكاوى والملاحظات</a>
    ...
    <a href="responsible_view.php">المسئولين</a>
    <a href="permisions_responsible.php">صلاحيات المسئولين</a>
		
		
    <a href="users_view.php">المستخدمين</a>
    <a href="permisions.php">صلاحيات المستخدمين</a>

    <a href="trainers_view.php">المدربين</a>

    <a href="members_view.php">الأعضاء</a>
    <a href="members_deleted.php">الأعضاء المحذوفة</a>
