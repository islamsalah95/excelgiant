...
if(isset($_POST['submit'])){
    $to = "info@sport-tower.com"; // this is your Email address
    $from = $_POST['email']; // this is the sender's Email address
    $first_name = $_POST['first_name'];
    $last_name = $_POST['last_name'];
    $subject = "رسالة من اكسيل للحلول البرمجية";
    $subject2 = "رسالة من اكسيل للحلول البرمجية";
    $message = $first_name . " " . $last_name . " wrote the following:" . "\n\n" . $_POST['message'];
    $message2 = "رسالة من اكسيل للحلول البرمجية" . $first_name . "\n\n" . $_POST['message'];
...
?>
              ...
              <tr>
                <td width="200"><h3><strong>فرع محدد</strong></h3></td>
