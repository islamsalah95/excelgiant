...
<script src="../SpryAssets/SpryValidationTextField.js" type="text/javascript"></script><script src="../SpryAssets/SpryValidationSelect.js" type="text/javascript"></script>
        ...
        grad_img1.value = grad_img.value.substring(fileNameIndex + 1);
          ...
          <tr valign="baseline">
            ...
            <span class="textfieldRequiredMsg">*</span></span><span id="sprytextfield2">
              <input type="hidden" name="bname" size="32" />
          ...
          <tr valign="baseline">
            ...
            <td><span id="sprytextfield5">
              <input name="grad_date" type="date" value="<?php echo  date("Y-m-d"); ?>" size="32" />
            <span class="textfieldRequiredMsg">*</span></span><span id="">
...
?>
          ...
          <tr valign="baseline">
            ...
            <td><input name="username2" type="text" value="<?php echo date("Ymdhis"); ?>" size="32" /></td>
          </tr>
          <tr valign="baseline">
          ...
          <tr valign="baseline">
            ...
            <td><span id="spryconfirm2">
              ...
              <input name="text2" type="password" id="text2" value="123" size="32" />
...
var spryconfirm2 = new Spry.Widget.ValidationConfirm("spryconfirm2", "password", {isRequired:false});
