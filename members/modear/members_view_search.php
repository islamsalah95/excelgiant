...
<table width="100%" border="0" cellpadding="2" cellspacing="2" dir="rtl">
  ...
  <tr>
    <td><table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
      <tr>
        <td><form id="form1" name="form1" method="get" action="../modear/members_view_searchn.php">
      ...
      <tr>
        <td><form id="form1" name="form1" method="get" action="../modear/members_view_search.php">
          <table border="0" align="center" cellpadding="1" cellspacing="1">
            <tr>
              <td>&nbsp;</td>
              <td>اسم العضو</td>
