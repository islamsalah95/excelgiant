...
$query_Recordset1 = sprintf("SELECT * FROM modear WHERE id = %s", GetSQLValueString($colname_Recordset1, "int"));
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  ...
  $updateGoTo = "modear_view.php?sub_syndicate=" . $row_Recordset1['sub_syndicate'] . "";
  if (isset($_SERVER['QUERY_STRING'])) {
    ...
    <td>&nbsp;
      <form action="<?php echo $editFormAction; ?>" method="post" enctype = "multipart/form-data" name="form1" id="form1">
        <table align="center">
          ...
          <tr valign="baseline">
            <td align="right" nowrap="nowrap">اسم الأمين:</td>
