...
<thead>
  <tr bgcolor="">
    <th colspan="7" align="center" nowrap="nowrap"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td colspan="2" align="center"><h2><strong><span dir="rtl">  تقرير منتسبي فرع </span></strong></h2></td>
      </tr>
      <tr>
        <td width="50%"><strong>الوحدة الحزبية: 
...
?>
  ...
  <tr bgcolor="#7470B3">
    ...
    <th width="100" align="center" nowrap="nowrap"><strong>الوحدة الحزبية</strong></th>
    <th width="100" align="center" nowrap="nowrap">نوع النشاط</th>
    <th width="100" align="center">الصفة</th>
    </tr>
  </thead>
  <?php do { ?>
  <tr align="center">
...
?>
    ...
    <td width="100"><?php echo $row_Recordset1['work_place']; ?></td>
    </tr>
