...
$query_Recordset1 = "SELECT * FROM form1 ORDER BY exp_date DESC";
...
<thead>
  <tr bgcolor="">
    <th colspan="7" align="center" nowrap="nowrap"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td colspan="2" align="center"><h2><strong><span dir="rtl">  تقرير انتهاء الصلاحية لمنتسبي فرع لكافة الخدمات</span></strong></h2></td>
      </tr>
      <tr>
        <td width="50%">&nbsp;</td>
