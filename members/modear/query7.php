...
if (isset($_GET['exp_date'])) {
  $colname_Recordset1 = $_GET['exp_date'];
}
mysqli_query($connection, $query)($database_connection, $connection);
$query_Recordset1 = sprintf("SELECT * FROM form1 WHERE exp_date > %s ORDER BY exp_date DESC", GetSQLValueString($colname_Recordset1, "date"));
...
<thead>
  <tr bgcolor="">
    <th colspan="7" align="center" nowrap="nowrap"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td colspan="2" align="center"><h2><strong><span dir="rtl">  تقرير انتهاء الصلاحية لمنتسبي فرع لكافة الخدمات<br />
          حتى تاريخ محدد
          <br />
        </span></strong></h2></td>
      </tr>
  ...
  <tr bgcolor="#7470B3">
    ...
    <th width="100" align="center" nowrap="nowrap"><strong>تاريخ اتتهاء الصلاحية</strong></th>
    ...
    <th width="100" align="center" nowrap="nowrap">نوع الخدمة</th>
  </tr>
  </thead>
  <?php do { ?>
  <tr align="center">
    ...
    <td width="100" align="center" nowrap="nowrap"><?php echo $row_Recordset1['exp_date']; ?></td>
