...
mysqli_query($connection, $query)($database_connection, $connection);
$query_Recordset1 = sprintf("SELECT * FROM sadmin WHERE sub_syndicate = %s ORDER BY id DESC", GetSQLValueString($colname_Recordset1, "int"));
...
mysqli_query($connection, $query)($database_connection, $connection);
$query_DetailRS1 = sprintf("SELECT * FROM sadmin WHERE id = %s", GetSQLValueString($colname_DetailRS1, "int"));
...
mysqli_query($connection, $query)($database_connection, $connection);
$query_rsusers = "SELECT * FROM modear";
