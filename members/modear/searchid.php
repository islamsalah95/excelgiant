...
if (isset($_GET['NID'])) {
  $colname_Recordset1 = $_GET['NID'];
}
mysqli_query($connection, $query)($database_connection, $connection);
$query_Recordset1 = sprintf("SELECT * FROM mwmembers WHERE NID = %s ORDER BY id DESC", GetSQLValueString($colname_Recordset1, "text"));
...
<table width="100%" border="0" cellpadding="6" cellspacing="6" dir="rtl">
  ...
  <tr>
    <td><table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td height="30"><form id="form1" name="form1" method="get" action="searchid.php">
          <table border="0" align="center" cellpadding="1" cellspacing="1">
            <tr>
              <td>&nbsp;</td>
              <td>رقم قومي</td>
    ...
    <td>&nbsp;
      <table id="myTable" border="1">
        <tr align="center" bgcolor="#7470B3">
          ...
          <th>اشتراك العضوية</th>
          <th>الاشتراك التنظيمي</th>
        ...
        <?php do { ?>
          <tr>
            ...
            <td align="center"><?php echo $row_Recordset1['SadedOdwia']; ?></td>
            <td align="center"><?php echo $row_Recordset1['SadedTanzimi']; ?></td>
