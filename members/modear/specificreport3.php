...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td><table width="500" border="1" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td><form action="query3.php" method="get" name="form1" target="_new">
          <table width="400" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td>ختر نوع النشاط</td>
              <td><select name="member_activity">
                <option value="عضوة">عضوة</option>
                <option value="شركة أدوية">شركة أدوية</option>
                <option value="عضو صناعي">عضو صناعي</option>
                <option value="إعلام دوائي">إعلام دوائي</option>
                <option value="عضوة خاصة">عضوة خاصة</option>
                <option value="مستشفى">مستشفى</option>
                <option value="عضوة عامة">عضوة عامة</option>
