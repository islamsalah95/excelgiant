...
<table width="100%" border="0" cellpadding="2" cellspacing="2" dir="rtl">
  <tr>
    <td align="center"><h2><strong>الوحدات الحزبية</strong></h2></td>
  </tr>
  <tr>
    <td><hr /></td>
  </tr>
  ...
  <tr>
    <td><table id="myTable" width="95%" border="1" align="center" dir="rtl">
        <tr bgcolor="#7470B3">
          <th nowrap="nowrap"><strong>اسم الوحدة الحزبية</strong></th>
          <th nowrap="nowrap">عنوان الوحدة الحزبية</th>
          <th width="100" nowrap="nowrap">الأمين</th>
          <th width="100" nowrap="nowrap">الصفة</th>
          <th width="50" align="center" nowrap="nowrap"><strong>تعديل</strong></th>
          <th width="50" align="center" nowrap="nowrap">إضافة مدن</th>
        </tr>
        <?php do { ?>
          <tr align="center">
            <td nowrap="nowrap"><p><?php echo $row_Recordset1['name']; ?> </p></td>
            <td nowrap="nowrap"><?php echo $row_Recordset1['address']; ?></td>
            <td width="100" nowrap="nowrap"><?php echo $row_Recordset1['syndadmin']; ?></td>
            <td width="100" nowrap="nowrap"><?php echo $row_Recordset1['syndadminjop']; ?></td>
            <td width="50"><a href="towns_edit.php?id=<?php echo $row_Recordset1['id']; ?>" target="_new"><i class="fa fa-edit" aria-hidden="true"></i></a></td>
            <td width="50"><a href="city_add.php?sub_syndicateid=<?php echo $row_Recordset1['id']; ?>">+</a></td>
          </tr>
