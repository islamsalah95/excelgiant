...
mysqli_query($connection, $query)($database_connection, $connection);
$query_Recordset1 = sprintf("SELECT * FROM trainers WHERE sub_syndicate = %s ORDER BY id DESC", GetSQLValueString($colname_Recordset1, "text"));
  ...
  <tr>
    ...
    function updateFileName2() {
        ...
        <tr valign="baseline">
          ...
          <td><input type="date" name="grad_date" value="" size="32" /></td>
        </tr>
        <tr valign="baseline">
