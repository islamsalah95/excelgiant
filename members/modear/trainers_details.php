...
mysqli_query($connection, $query)($database_connection, $connection);
$query_DetailRS1 = sprintf("SELECT * FROM trainers WHERE id = %s", GetSQLValueString($colname_DetailRS1, "int"));
...
mysqli_query($connection, $query)($database_connection, $connection);
$query_rsusers = "SELECT * FROM trainers";
...
<table width="100%" border="0" cellpadding="2" cellspacing="2" dir="rtl">
  ...
  <tr>
    <td><table width="80%" align="center" cellpadding="2" cellspacing="2">
      ...
      <tr>
        <th nowrap="nowrap" bgcolor="#7470B3">تاريخ بدء العمل</th>
...
?>
      ...
      <tr>
        <th nowrap="nowrap" bgcolor="#7470B3">القسم</th>
        <td bgcolor="#FFFFFF">&nbsp;	&nbsp;	&nbsp;
          <select name="select" id="select">
            <?php
do {  
?>
            <option value="<?php echo $row_rsbanks['id']?>"<?php if (!(strcmp($row_rsbanks['id'], $row_DetailRS1['group_id']))) {echo "selected=\"selected\"";} ?>><?php echo $row_rsbanks['name']?></option>
            <?php
