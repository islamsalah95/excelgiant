...
$query_Recordset1 = sprintf("SELECT * FROM trainers WHERE id = %s", GetSQLValueString($colname_Recordset1, "int"));
...
mysqli_query($connection, $query)($database_connection, $connection);
$query_Recordset2 = sprintf("SELECT * FROM trainers WHERE sub_syndicate = %s", GetSQLValueString($colname_Recordset2, "text"));
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  ...
  $updateGoTo = "trainers_view.php?sub_syndicate=" . $row_Recordset1['sub_syndicate'] . "";
  if (isset($_SERVER['QUERY_STRING'])) {
  ...
  <tr>
    <td>&nbsp;
      <form action="<?php echo $editFormAction; ?>" method="post" enctype = "multipart/form-data" name="form1" id="form1">
        <table align="center">
          ...
          <tr valign="baseline">
            <td align="right" nowrap="nowrap">اسم المستخدم:</td>
    ...
    function updateFileName2() {
        ...
        grad_img1.value = grad_img.value.substring(fileNameIndex + 1);
          ...
          <tr valign="baseline">
            <td align="right" nowrap="nowrap">تاريخ بدء العمل:</td>
            <td><input type="date" name="grad_date" value="<?php echo htmlentities($row_Recordset1['grad_date'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
          </tr>
          <tr valign="baseline">
...
?>
          ...
          <tr valign="baseline">
            <td align="right" nowrap="nowrap">العمل العام:</td>
            <td><select name="group_id2">
              <option value="" <?php if (!(strcmp("", $row_Recordset1['group_id']))) {echo "selected=\"selected\"";} ?>>اختر</option>
              <?php
do {  
?>
              <option value="<?php echo $row_rsbanks['id']?>"<?php if (!(strcmp($row_rsbanks['id'], $row_Recordset1['group_id']))) {echo "selected=\"selected\"";} ?>><?php echo $row_rsbanks['name']?></option>
              <?php
