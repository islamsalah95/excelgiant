...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO university1 (id, name, branch, `section`, `description`, duration, durationstop, tamrinat, price, other, create_date, edit_date, create_by, edit_by) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
  ...
  $insertGoTo = "university1_view.php";
  if (isset($_SERVER['QUERY_STRING'])) {
