...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE university1 SET name=%s, branch=%s, `section`=%s, `description`=%s, duration=%s, durationstop=%s, tamrinat=%s, price=%s, other=%s, syndadmin=%s, syndadminjop=%s, create_date=%s, edit_date=%s, create_by=%s, edit_by=%s WHERE id=%s",
  ...
  $updateGoTo = "university1_view.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysqli_query($connection, $query)($database_connection, $connection);
$query_Recordset1 = sprintf("SELECT * FROM university1 WHERE id = %s ORDER BY id ASC", GetSQLValueString($colname_Recordset1, "int"));
