...
mysqli_query($connection, $query)($database_connection, $connection);
$query_Recordset1 = "SELECT * FROM university1 ORDER BY id ASC";
...
<table width="100%" border="0" cellpadding="2" cellspacing="2" dir="rtl">
  <tr>
    <td align="center"><h2><strong>باقات فتنس مكس</strong></h2></td>
  </tr>
  <tr>
    <td><hr /></td>
  </tr>
  ...
  <script type="text/javascript">
    ...
    searchBtn.addEventListener("click", function () {
      ...
      const searchResult = window.find(search);
        ...
        <td height="30" align="center" bgcolor="#D9EAF4"><a href="university1_add.php"><i class="fa fa-plus" aria-hidden="true"></i> إضافة </a></td>
  ...
  <tr>
    <td><table id="myTable" width="95%" border="1" align="center" dir="rtl">
        <tr bgcolor="#7470B3">
          ...
          <th nowrap="nowrap">الوحدة الحزبية</th>
          <th nowrap="nowrap">القسم</th>
          <th nowrap="nowrap">وصف الباقة</th>
          <th nowrap="nowrap">المدة</th>
          <th nowrap="nowrap">فترة الايقاف</th>
          <th nowrap="nowrap">عدد التمرينات</th>
          <th nowrap="nowrap">السعر</th>
        ...
        <?php do { ?>
          <tr align="center">
            ...
            <td><?php echo $row_Recordset1['duration']; ?></td>
            <td><?php echo $row_Recordset1['durationstop']; ?></td>
            <td><?php echo $row_Recordset1['tamrinat']; ?></td>
            <td><?php echo $row_Recordset1['price']; ?></td>
            <td><?php echo $row_Recordset1['other']; ?></td>
            <td width="50"><a href="university1_edit.php?id=<?php echo $row_Recordset1['id']; ?>" target="_new"><i class="fa fa-edit" aria-hidden="true"></i></a></td>
            <td width="50"><a href="university1_delete.php?id=<?php echo $row_Recordset1['id']; ?>" target="_new"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
          </tr>
