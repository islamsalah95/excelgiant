  ...
  <script type="text/javascript">
    ...
    searchBtn.addEventListener("click", function () {
      ...
      const searchResult = window.find(search);
        ...
        <td height="30" align="center" bgcolor="#D9EAF4"><a href="university_add.php"><i class="fa fa-plus" aria-hidden="true"></i> إضافة </a></td>
    ...
    <td><table id="myTable" width="95%" border="1" align="center" dir="rtl">
        ...
        <?php do { ?>
          <tr align="center">
            ...
            <td width="50"><a href="university_edit.php?id=<?php echo $row_Recordset1['id']; ?>" target="_new"><i class="fa fa-edit" aria-hidden="true"></i></a></td>
            <td width="50"><a href="university_delete.php?id=<?php echo $row_Recordset1['id']; ?>" target="_new"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
          </tr>
