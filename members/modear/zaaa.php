...
<div class="topnav" id="myTopnav" style="">
  ...
  <div>
    <p align="center">اكسيل للحلول البرمجية - مرحباً يا : <?php echo $_SESSION['MM_Username'] ?> - <strong><?php echo $row_Recordset1['first_name']; ?></strong> <strong><?php echo $row_Recordset1['bname']; ?></strong> <strong><?php echo $row_Recordset1['cname']; ?></strong> <strong><?php echo $row_Recordset1['last_name']; ?></strong></p>
...
<div class="w3-container w3-card w3-white w3-margin-bottom" style="background-image: linear-gradient(WHITE, WHITE,  WHITE,  WHITE,  WHITE,  WHITE, gray);">
  ...
  <div class="content">
    <ul id="sdt_menu" class="sdt_menu">
      ...
      <li> <a href="#"> <img src="6.jpg" alt=""/> <span class="sdt_active"></span> <span class="sdt_wrap"> <span class="sdt_link">الحسابات</span> <span class="sdt_descr">الحسابات البنكية للفرع</span></span></a>
        <div class="sdt_box"> <a href="banks">الاقسام</a> <a href="payments">سندات القبض</a></div>
        </li>
      <li> <a href="#"> <img src="4.jpg" alt=""/> <span class="sdt_active"></span> <span class="sdt_wrap"> <span class="sdt_link">وثائق وتقارير</span> <span class="sdt_descr">وثائق الالكترونية</span></span></a>
        <div class="sdt_box"> <a href="forms.php">النماذج</a> <a href="reports">التقارير</a> <a href="requestes">الطلبات</a> <a href="notes">الملاحظات</a> <a href="complaints">الشكاوي</a></div>
        </li>
      <li> <a href="#"> <img src="9.jpg" alt=""/> <span class="sdt_active"></span> <span class="sdt_wrap"> <span class="sdt_link">البيانات الاساسية</span> <span class="sdt_descr">البيانات الاساسية للفرع</span></span></a>
        <div class="sdt_box"> <a href="users">المستخدمين</a> <a href="members">الأعضاء</a> <a href="members/index_deleted">الأعضاء المحذوفة</a> <a href="towns">الاقسام</a> <a href="groups">المجموعات</a></div>
        </li>
      </ul>
  </div>
</td>
