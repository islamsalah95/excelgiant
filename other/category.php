...
mysqli_select_db($connection, "excelgia_mahmdata");
$query_Recordset3 = sprintf("SELECT * FROM blogs WHERE category = %s ORDER BY id ASC", GetSQLValueString($colname_Recordset3, "text"));
...
mysqli_select_db($connection, "excelgia_mahmdata");
$query_Recordset6 = sprintf("SELECT * FROM categoryat WHERE category = %s", GetSQLValueString($colname_Recordset6, "text"));
...
<div id="spinner" class="show bg-white position-fixed translate-middle w-100 vh-100 top-50 start-50 d-flex align-items-center justify-content-center">
    ...
    <div class="container-fluid position-relative p-0" dir="rtl">
        ...
        <img src="img/<?php echo $row_Recordset1['grad_img']; ?>" height="70">
        <style>
body {
  margin: 0;
...
<div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
  ...
  <tr>
    <td align="center"><img src="img/<?php echo $row_Recordset6['image']; ?>" width="350"></td>
  </tr>
  <tr>
    <td align="center" bgcolor="#DDF9FF"><h2><?php echo $row_Recordset6['category']; ?></h2></td>
  </tr>
</table>
