...
<div id="spinner" class="show bg-white position-fixed translate-middle w-100 vh-100 top-50 start-50 d-flex align-items-center justify-content-center">
    ...
    <div class="container-fluid position-relative p-0" dir="rtl">
      <nav class="navbar navbar-expand-lg navbar-dark px-5 py-3 py-lg-0"> <img src="img/<?php echo $row_Recordset1['grad_img']; ?>" alt="" height="70">
        <div></div>
        <style>
body {
  margin: 0;
...
@media screen and (max-width: 600px) {
  ...
  <a href="#"></a>  <a href="index.php">الرئيسية</a>   <a href="contact.php">اتصل بنا</a> <a href="javascript:void(0);" class="icon" onClick="myFunction()"> <i class="fa fa-bars"></i> </a> </div>
        <script>
function myFunction() {
      ...
      <div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 90px;">
        <div class="row py-5">
          <div class="col-12 pt-lg-5 mt-lg-5 text-center">
            ...
            <a href="" class="h5 text-white"><?php echo $row_Recordset1['bname']; ?></a> </div>
        </div>
      </div>
    </div>
    <!-- Navbar End -->
        ...
        <div class="container py-5">
            <div class="row g-5">
                ...
                <div class="col-lg-8" dir="rtl">
                    <!-- Blog Detail Start -->
                    <div class="mb-5">
                        <img src="contactus.jpg" alt="" width="350" class="img-fluid w-100 rounded mb-5">
                      <h1 class="mb-4">اتصل بنا</h1>
                        <h3>"لمزيد من المعلومات يرجى التواصل معنا على "                          </h3>
                        <h3><i style="font-size:24px" class="fa">&#xf10b;</i>01149220950</h3>
                        <h3><i style="font-size:24px" class="fa">&#xf0e0;</i> info@excelgiants.site<br>
                      </h3>
                        <h3><i style="font-size:24px" class="fa">&#xf124;</i> السويس                           </h3>
<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1224.5129973207247!2d31.22397832183883!3d31.171071802089383!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14f70b19c2450153%3A0xe264b991d40a4afd!2z2KfZhNio2YbZgyDYp9mE2KfZh9mE2Ykg2KfZhNmF2LXYsdmJINmB2LHYuSDYqNmK2YTYpw!5e0!3m2!1sar!2seg!4v1691151241283!5m2!1sar!2seg" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>                  </div>
                    <!-- Blog Detail End -->
