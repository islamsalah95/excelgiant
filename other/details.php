...
<script type="text/javascript" src="https://platform-api.sharethis.com/js/sharethis.js#property=652284657b301100121bcf2e&product=inline-share-buttons&source=platform" async="async"></script>
</head>
        ...
        <div class="container py-5">
            <div class="row g-5">
                ...
                <div class="col-lg-8" dir="rtl">
                    <!-- Blog Detail Start -->
                    <div class="mb-5">
                        <img class="img-fluid w-100 rounded mb-5" src="img/<?php echo $row_Recordset6['image']; ?>" alt="">
                        <h1 class="mb-4"><?php echo $row_Recordset6['title']; ?></h1>
                        <?php echo $row_Recordset6['topic']; ?>
                        
<table border="0" cellspacing="6" cellpadding="6">
  <tr>
    <td width="50">&nbsp;</td>
    <td><a href="img/<?php echo $row_Recordset6['malaf']; ?>" target="_new"><img src="down.png" width="50" height="50" border="0"></a></td>
    <td><strong>تحميل الملفات </strong></td>
  </tr>
</table>                    
</div>
