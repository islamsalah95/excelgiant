...
<head>
    ...
    <meta content="<?php echo $row_Recordset1['description']; ?>" name="description">
...
<meta name="title" content="اكسيل للحلول البرمجية" />
<meta name="description" content="البرمجة التقنية والخدمات الالكترونية" />

<!-- Open Graph / Facebook -->
<meta property="og:type" content="website" />
<meta property="og:url" content="https://new.excelgiants.site/" />
<meta property="og:title" content="اكسيل للحلول البرمجية" />
<meta property="og:description" content="البرمجة التقنية والخدمات الالكترونية" />
<meta property="og:image" content="https://new.excelgiants.site/img/logo.png" />

<!-- Twitter -->
<meta property="twitter:card" content="summary_large_image" />
<meta property="twitter:url" content="https://new.excelgiants.site/" />
<meta property="twitter:title" content="اكسيل للحلول البرمجية" />
<meta property="twitter:description" content="البرمجة التقنية والخدمات الالكترونية" />
<meta property="twitter:image" content="https://new.excelgiants.site/img/logo.png" />
...
<div class="topnav" id="myTopnav">
  <a href="#"></a>  <a href="index.php">الرئيسية</a>
        ...
        <div class="container py-5">
            <div class="row g-5">
                ...
                <div class="col-lg-8">
                    <div class="row g-5">
                        <?php do { ?>
                        <div class="col-md-6 wow slideInUp" data-wow-delay="0.<?php echo $row_Recordset3['id']; ?>s">
                            <div class="blog-item bg-light rounded overflow-hidden">
                              <div class="blog-img position-relative overflow-hidden">
                                <img style="margin-left: auto; margin-right: auto; width: 350px; height:200px" src="img/<?php echo $row_Recordset3['image']; ?>" alt="">
                                
                              </div>
                              <div class="p-4" dir="rtl">
                                <div class="d-flex mb-3">
                                  <small class="me-3"><i class="far fa-user text-primary me-2"></i>  <?php echo $row_Recordset3['tauther']; ?>  </small>
                                  <small><i class="far fa-calendar-alt text-primary me-2"></i>  <?php echo $row_Recordset3['tdate']; ?>  </small>
                                </div>
                                <h4 class="mb-3"><?php echo $row_Recordset3['title']; ?></h4>
                                <p><?php echo $row_Recordset3['samary']; ?></p>
                                <a class="text-uppercase" href="details.php?id=<?php echo $row_Recordset3['id']; ?>"> المزيد ...<i class="bi bi-arrow-right"></i></a>
                              </div>
                          </div>
                        </div>
              ...
              <div class="col-lg-4">
                ...
                <div class="mb-5 wow slideInUp" dir="rtl" data-wow-delay="0.1s">
                        ...
                        <?php do { ?>
                        <div style="width:100%; background-color:#9b948e">
...
<div class="slideshow-container">
  ...
  <?php do { ?>
    <div class="mySlides fade">
      <div class="numbertext"><?php echo $row_Recordset6['id']; ?> / </div>
      <img src="img/<?php echo $row_Recordset6['grad_img']; ?>" style="width:100%">
      <div class="text"><?php echo $row_Recordset6['first_name']; ?></div>
  </div>
