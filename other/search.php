...
if (isset($_GET['title'])) {
  $colname_Recordset3 = $_GET['title'];
}
mysqli_select_db($connection, "excelgia_mahmdata");
$query_Recordset3 = sprintf("SELECT * FROM blogs WHERE title LIKE %s ORDER BY id ASC", GetSQLValueString("%" . $colname_Recordset3 . "%", "text"));
...
<span class="text1" ><marquee behavior="scroll" direction="left" onmouseover="this.stop();" onmouseout="this.start();">
<?php do { ?>
                        ...
                        <div class="col-md-6 wow slideInUp" data-wow-delay="0.<?php echo $row_Recordset3['id']; ?>s">
                            <div class="blog-item bg-light rounded overflow-hidden">
                              <div class="blog-img position-relative overflow-hidden">
                                <img class="img-fluid" src="img/<?php echo $row_Recordset3['image']; ?>" alt="">
                                <a class="position-absolute top-0 start-0 bg-primary text-white rounded-end mt-5 py-2 px-4" href=""><?php echo $row_Recordset3['category']; ?></a>
                              </div>
