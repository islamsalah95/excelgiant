                ...
                <form wire:submit.prevent="submit" class="browser-default-validation">
                            ...
                            <div class="card-body">
                                <div class="needsclick">
                                    <div class="dz-message needsclick">
                                        ...
                                        <div>
                                            <img style="max-width: 300px; max-height:300px;" src="{{ $services->getFirstMediaUrl('services') ?? '' }}" alt="{{ __('admins/profile.profile_image_alt') }}">
                                        </div>
                                    </div>
                                    <div class="fallback">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="name_en" class="form-control @error('name_en') is-invalid @enderror"
                            wire:model="name_en" placeholder="{{ __('services/edit.placeholders.name_en') }}">
                        @error('name_en')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="slug_ar"
                            class="form-control @error('slug_ar') is-invalid @enderror "dir="rtl" wire:model="slug_ar"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="slug_en" class="form-control @error('slug_en') is-invalid @enderror"
                            wire:model="slug_en" placeholder="{{ __('services/edit.placeholders.slug_en') }}">
                        @error('slug_en')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea id="desc_ar" class="form-control" dir="ltr">{!! json_decode($services->blog['desc'], true)['ar'] !!}</textarea>
                    </div>

                    <!-- Description (English) -->
                    <div class="mb-3">
                        <label for="desc_en" class="form-label">{{ __('services/edit.labels.desc_en') }}</label>
                        <textarea id="desc_en" class="form-control">{!! json_decode($services->blog['desc'], true)['en'] !!}</textarea>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-12" style="display: flex; justify-content: center;">
                            <button type="submit"
                                class="btn btn-primary waves-effect waves-light">{{ __('services/edit.buttons.save') }}</button>
                        </div>
                    </div>
                </form>
            </div>
