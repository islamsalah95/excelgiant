      ...
      <div class="row g-0 align-items-center flex-column-reverse flex-md-row">
        ...
        <div class="col-md-6 animated fadeIn">
          <div class="owl-carousel header-carousel">
            ...
            <?php else: ?>
              <div class="owl-carousel-item">
                <img class="img-fluid" src="img/default-slide.jpg" alt="Default Slide">
              </div>
            <?php endif; ?>
          </div>
        </div>
      ...
      <div class="container">
        ...
        <div class="tab-content">
          <div id="tab-1" class="tab-pane fade show p-0 active">
            ...
            <div class="row g-4">
              <?php if ($totalRows_rssingle > 0): ?>
                <?php do { ?>
                  <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="property-item rounded overflow-hidden">
                      <div class="position-relative overflow-hidden">
                        <a href="details.php?id=<?php echo $row_rssingle['id']; ?>#about">
                          <img width="100%" class="img-fluid" src="img/<?php echo $row_rssingle['image']; ?>" alt="">
                        </a>
                        <div class="bg-primary rounded text-white position-absolute start-0 top-0 m-4 py-1 px-3">
                          <?php echo $row_rssingle['category']; ?>
                        </div>
                        <div class="bg-white rounded-top text-primary position-absolute start-0 bottom-0 mx-4 pt-1 px-3">
                          <?php echo $row_rssingle['tdate']; ?>
                        </div>
                      </div>
                      <div class="p-4 pb-0">
                        <a class="d-block h5 mb-2" href="details.php?id=<?php echo $row_rssingle['id']; ?>#about">
                          <?php echo $row_rssingle['title']; ?>
                        </a>
