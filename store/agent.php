...
$query_Recordset1 = sprintf("SELECT * FROM orders WHERE userId = %s ORDER BY id DESC", GetSQLValueString($colname_Recordset1, "int"));
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="00" dir="rtl">
  ...
  <tr>
    <td height="50" align="center" valign="bottom"><h1>تقرير عن عمليات وكيل محدد</h1></td>
  </tr>
  <tr>
