...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="00" dir="rtl">
  ...
  <tr>
    <td height="50" align="center" valign="bottom"><h1>تقرير عن عمليات وكيل محدد الفترة</h1></td>
  </tr>
  <tr>
      ...
      <tbody>
        <?php
			if (isset($_POST['submit'])){
				...
				$name=($_POST['name']);
				$oquery=$conn->query("select * from `orders` where orderDate between '$from' and '$to' AND userId = '$name'");
