...
$query_Recordset1 = sprintf("SELECT * FROM orders WHERE userId = %s", GetSQLValueString($colname_Recordset1, "int"));
...
mysqli_select_db($connection, "excelgia_mahmdata");
$query_Recordset3 = "SELECT * FROM slidat ORDER BY name ASC";
...
<table width="100%" border="0" cellspacing="2" cellpadding="2">
  ...
  <tr>
    <td align="center"><h1 align="center"><strong>تقرير عن عميل</strong></h1></td>
  </tr>
  <tr>
