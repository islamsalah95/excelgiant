...
@media screen and (max-width: 600px) {
  ...
  <a href="#"></a>   <a href="index.php">الرئيسية</a><a href="academy.php">الوسيط اكاديمي</a>  <a href="contact.php">اتصل بنا</a> <a href="javascript:void(0);" class="icon" onClick="myFunction()"> <i class="fa fa-bars"></i> </a> </div>
        <script>
function myFunction() {
                ...
                <div class="col-lg-8" dir="rtl">
                    ...
                    <div class="mb-5">
                      ...
                      <h1 class="mb-4">اتصل بنا</h1>
                        ...
                        <h3><i style="font-size:24px" class="fa">&#xf095;</i> <?php echo $row_Recordset1['country']; ?> </h3>
                        <h3><i style="font-size:24px" class="fa">&#xf0e0;</i> <?php echo $row_Recordset1['grad_place']; ?><br>
                        </h3>
                        <h3><i style="font-size:24px" class="fa">&#xf124;</i> <?php echo $row_Recordset1['work_place']; ?></h3>
                      <p></p>
