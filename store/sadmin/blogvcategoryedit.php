...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE blogvides SET title=%s, image=%s, samary=%s, category=%s, topic=%s, tdate=%s, tauther=%s WHERE id=%s",
  ...
  $updateGoTo = "blogvcategoryview.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysqli_select_db($connection, "excelgia_mahmdata");
$query_Recordset2 = sprintf("SELECT * FROM blogvides WHERE id = %s", GetSQLValueString($colname_Recordset2, "int"));
