...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO decision (id, title, topic) VALUES (%s, %s, %s)",
    ...
    <td><form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
      <table align="center">
        <tr valign="baseline">
          ...
          <td><input type="date" name="title" value="" size="32" /></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right" valign="top">نص القرار:</td>
          <td><textarea name="topic" cols="50" rows="5"></textarea></td>
        </tr>
        <tr valign="baseline">
