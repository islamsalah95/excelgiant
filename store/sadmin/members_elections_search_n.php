...
<table width="100%" border="0" cellpadding="2" cellspacing="2" dir="rtl">
  <tr>
    <td align="center"><h2><strong>البطاقة الانتخابية للأعضاء</strong></h2></td>
  </tr>
  <tr>
    <td><hr /></td>
  </tr>
  <tr>
    <td><table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
      <tr>
        <td height="30"><form id="form1" name="form1" method="get" action="../sadmin/members_elections_search.php">
  ...
  <tr>
    <td height="30"><form id="form2" name="form1" method="get" action="../sadmin/members_elections_search_n.php">
      <table border="0" align="center" cellpadding="1" cellspacing="1">
        <tr>
          <td>&nbsp;</td>
          <td>اسم العضو</td>
          <td><input type="text" name="aname" id="aname" /></td>
          <td><input type="submit" name="button2" id="button2" value="بحث" /></td>
        </tr>
      </table>
    </form>
...
?>
            ...
            <td width="50"><a href="electioncard.php?id=<?php echo $row_Recordset1['id']; ?>" target="_new"><i class="fa fa-eye" aria-hidden="true"></i></a></td>
          </tr>
