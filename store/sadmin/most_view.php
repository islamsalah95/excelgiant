...
$query_Recordset1 = "SELECT * FROM mostakhdem ORDER BY id DESC";
...
<table width="100%" border="0" cellpadding="2" cellspacing="2" dir="rtl">
  ...
  <tr>
    <td><table width="200" border="1" align="left">
      <tr>
        <td height="30" align="center" bgcolor="#D9EAF4"><a href="most_add.php"><i class="fa fa-plus" aria-hidden="true"></i> إضافة </a></td>
      </tr>
    </table></td>
  </tr>
  <tr>
      ...
      <table  id="myTable" border="1" align="center">
        ...
        <?php do { ?>
          <tr>
            ...
            <td width="50" align="center"><a href="most_edit.php?id=<?php echo $row_Recordset1['id']; ?>">تعديل</a></td>
            <td width="50" align="center"><a href="most_delete.php?id=<?php echo $row_Recordset1['id']; ?>">حذف</a></td>
          </tr>
