...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO oroudpro (id, category, subCategory, productName, productCompany, productPrice, productPriceBeforeDiscount, productDescription, image, photo, picture, shippingCharge, productAvailability, postingDate, updationDate) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
  ...
  <tr>
    <td>&nbsp;
      <form action="<?php echo $editFormAction; ?>" method="post" enctype="multipart/form-data" name="form1" id="form1">
        ...
        <input name="category" type="hidden" id="category" value="عروض" />
