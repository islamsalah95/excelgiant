...
mysqli_select_db($connection, "excelgia_mahmdata");
$query_Recordset1 = "SELECT * FROM slidat";
...
<table width="100%" border="0" cellpadding="4" cellspacing="4" dir="rtl">
  <tr>
    <td align="center"><h2><strong>صلاحيات عارض الصور</strong></h2></td>
  </tr>
  <tr>
    <td><hr /></td>
  </tr>
    ...
    <td>&nbsp;
      <?php if ($totalRows_Recordset2 > 0) { // Show if recordset not empty ?>
        <form action="<?php echo $editFormAction; ?>" method="post" name="form2" id="form2">
          <table align="center">
      <tr valign="baseline">
        <td nowrap="nowrap" align="right">عارض الصور:
      ...
      <tr valign="baseline">
        <td nowrap="nowrap" align="right">المدن:</td>
      ...
      <tr valign="baseline">
        <td nowrap="nowrap" align="right">طلبات المراسلة:</td>
