...
<table width="100%" border="0" cellpadding="2" cellspacing="2" dir="rtl">
  ...
  <tr>
    <td><table width="80%" align="center" cellpadding="2" cellspacing="2">
      <tr>
        <th width="13%" nowrap="nowrap" bgcolor="#7470B3">الاسم الاول</th>
...
?>
      ...
      <tr>
        <th nowrap="nowrap" bgcolor="#7470B3">صورة التوقيع</th>
        <td bgcolor="#FFFFFF">&nbsp;	&nbsp;	&nbsp;<strong><img src="../img/<?php echo $row_DetailRS1['sign_img']; ?>" alt="" width="100" height="70" /></strong></td>
      </tr>
      <tr>
