...
mysqli_select_db($connection, "excelgia_mahmdata");
$query_Recordset1 = sprintf("SELECT * FROM responsible WHERE first_name LIKE %s ORDER BY id DESC", GetSQLValueString("%" . $colname_Recordset1 . "%", "text"));
...
<table width="100%" border="0" cellpadding="2" cellspacing="2" dir="rtl">
  ...
  <tr>
    <td><table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
      <tr>
        <td><form id="form1" name="form1" method="get" action="../sadmin/responsible_view_search.php">
    ...
    searchBtn.addEventListener("click", function () {
      ...
      const searchResult = window.find(search);
        ...
        <td width="100" height="30" align="center" bgcolor="#D9EAF4"><a href="responsible_add.php"><i class="fa fa-plus" aria-hidden="true"></i> إضافة </a></td>
  ...
  <tr>
    <td><table id="myTable" width="95%" border="1" align="center" dir="rtl">
        <tr bgcolor="#7470B3">
          ...
          <th nowrap="nowrap"><strong>اسم المسئول</strong></th>
        ...
        <?php do { ?>
          <tr align="center">
            <td><a href="responsible_details.php?recordID=<?php echo $row_Recordset1['id']; ?>"><?php echo $row_Recordset1['id']; ?></a></td>
...
?>
            ...
            <td width="50"><a href="responsible_details.php?recordID=<?php echo $row_Recordset1['id']; ?>" target="_new"><i class="fa fa-eye" aria-hidden="true"></i></a></td>
            <td width="50"><a href="responsible_edit.php?id=<?php echo $row_Recordset1['id']; ?>&amp;sub_syndicatea=<?php echo $row_Recordset1['sub_syndicate']; ?>" target="_new"><i class="fa fa-edit" aria-hidden="true"></i></a></td>
            <td width="50"><a href="responsible_delete.php?id=<?php echo $row_Recordset1['id']; ?>" target="_new"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
          </tr>
...
Records <?php echo ($startRow_Recordset1 + 1) ?> to <?php echo min($startRow_Recordset1 + $maxRows_Recordset1, $totalRows_Recordset1) ?> of <?php echo $totalRows_Recordset1 ?><table border="0" align="center" dir="ltr">
  ...
  <tr>
    <td><table width="100" border="0" align="left" cellpadding="0" cellspacing="0">
      <tr>
        <td height="30" align="center" bgcolor="#D9EAF4"><a href="responsible_add.php"><i class="fa fa-plus" aria-hidden="true"></i> إضافة </a></td>
      </tr>
    </table></td>
  </tr>
</table>
