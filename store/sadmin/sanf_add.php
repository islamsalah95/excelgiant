...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO products (id, category, subCategory, productName, productCompany, productPrice, productPriceBeforeDiscount, productDescription, image, photo, picture, shippingCharge, productAvailability, postingDate, updationDate) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
do {  
?>
              <option value="<?php echo $row_Recordset1['categoryName']?>" ><?php echo $row_Recordset1['categoryName']?></option>
              <?php
...
?>
          ...
          <tr valign="baseline">
            ...
            <td><input type="text" name="productPriceBeforeDiscount" value="" size="32" /></td>
          </tr>
          <tr valign="baseline">
          ...
          <tr valign="baseline">
            ...
            <td><input name="photo1" id="photo1" value="" size="32" />
          ...
          <tr valign="baseline">
            ...
            <td><input name="picture1" id="picture1" value="" size="32" />
          ...
          <tr valign="baseline">
            ...
            <td><input type="text" name="shippingCharge" value="" size="32" /></td>
          </tr>
          <tr valign="baseline">
            <td nowrap="nowrap" align="right">الحالة:</td>
            <td><select name="productAvailability">
              <option value="متاح" <?php if (!(strcmp("متاح", ""))) {echo "SELECTED";} ?>>متاح</option>
              <option value="غير متاح" <?php if (!(strcmp("غير متاح", ""))) {echo "SELECTED";} ?>>غير متاح</option>
            </select></td>
          </tr>
          <tr valign="baseline">
        ...
        <input type="hidden" name="postingDate" value="" />
