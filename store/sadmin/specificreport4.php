...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td><table width="500" border="1" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td><form action="query5.php" method="get" name="form1" target="_new">
          <table width="400" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td>ختر نوع المنشور</td>
              <td><select name="form_type" id="form_type">
                <option value="إذن مزاولة مهنة الصيدلة">إذن مزاولة مهنة الصيدلة</option>
                <option value="إفادة بمدة الخبرة العملية">إفادة بمدة الخبرة العملية</option>
                <option value="إذن إنشاء">إذن إنشاء</option>
                <option value="بطاقة العضوية">بطاقة العضوية</option>
              </select></td>
