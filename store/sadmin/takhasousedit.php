...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE takhasousat SET title=%s, details=%s WHERE id=%s",
...
mysqli_select_db($connection, "excelgia_mahmdata");
$query_Recordset1 = sprintf("SELECT * FROM takhasousat WHERE id = %s", GetSQLValueString($colname_Recordset1, "int"));
