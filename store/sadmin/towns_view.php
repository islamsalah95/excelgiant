...
<table width="100%" border="0" cellpadding="2" cellspacing="2" dir="rtl">
  <tr>
    <td align="center"><h2><strong>النقابات الفرعية</strong></h2></td>
  </tr>
  <tr>
    <td><hr /></td>
  </tr>
  ...
  <tr>
    <td><table id="myTable" width="95%" border="1" align="center" dir="rtl">
        <tr bgcolor="#7470B3">
          <th nowrap="nowrap"><strong>اسم النقابة</strong></th>
          <th nowrap="nowrap">عنوان النقابة</th>
          <th width="100" nowrap="nowrap">النقيب</th>
          <th width="100" nowrap="nowrap">المسمى الوظيفي</th>
