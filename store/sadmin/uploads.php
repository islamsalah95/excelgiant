...
if (isset($_POST['username'])) {
  ...
  $LoginRS__query=sprintf("SELECT username, password FROM slidat WHERE username=%s AND password=md5(%s)",
...
if(isset($_POST['submit'])){
	...
	$insert = $db->query("INSERT into images (file_name, uploaded_on, memper) VALUES ('".$targetFilePath."', NOW(), '".$memper."')");
