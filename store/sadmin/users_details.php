...
mysqli_select_db($connection, "excelgia_mahmdata");
$query_DetailRS1 = sprintf("SELECT * FROM slidat WHERE id = %s", GetSQLValueString($colname_DetailRS1, "int"));
  ...
  <tr>
    <td><table width="80%" align="center" cellpadding="2" cellspacing="2">
      ...
      <tr>
        ...
        <td bgcolor="#FFFFFF">&nbsp;	&nbsp;	&nbsp;<strong><img src="../img/<?php echo $row_DetailRS1['grad_img']; ?>" alt="" width="250" height="250" /></strong></td>
      </tr>
      <tr>
