...
$query_Recordset1 = sprintf("SELECT * FROM slidat WHERE id = %s", GetSQLValueString($colname_Recordset1, "int"));
...
mysqli_select_db($connection, "excelgia_mahmdata");
$query_Recordset2 = sprintf("SELECT * FROM slidat WHERE sub_syndicate = %s", GetSQLValueString($colname_Recordset2, "text"));
