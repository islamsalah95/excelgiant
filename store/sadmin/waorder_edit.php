...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE waorders SET name=%s, productname=%s, productcateg=%s, productprice=%s, productbonus=%s, quantity=%s, total=%s, totalbonus=%s, orderDate=%s, paymentMethod=%s, orderStatus=%s WHERE id=%s",
...
mysqli_select_db($connection, "excelgia_mahmdata");
$query_Recordset1 = sprintf("SELECT * FROM waorders WHERE id = %s", GetSQLValueString($colname_Recordset1, "int"));
