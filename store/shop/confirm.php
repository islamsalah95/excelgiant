...
mysqli_select_db($connection, "excelgia_mahmdata");
$query_rsproducts = sprintf("SELECT * FROM products WHERE id = %s", GetSQLValueString($colname_rsproducts, "int"));
        ...
        <div class="row px-xl-5">
            <div class="col-12">
                <nav class="breadcrumb bg-light mb-30">
                    ...
                    <a class="breadcrumb-item text-dark" href="category.php?category=<?php echo $row_rsproducts['category']; ?>"><?php echo $row_rsproducts['category']; ?></a>
                  <span class="breadcrumb-item active"><?php echo $row_rsproducts['productName']; ?></span>
                </nav>
            </div>
        </div>
    </div>
        ...
        <div class="row px-xl-5">
                ...
                <div id="product-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner bg-light">
                        <div class="carousel-item active">
                            <img class="w-100 h-100" src="https://new.excelgiants.site/img/<?php echo $row_rsproducts['image']; ?>" alt="Image">
                        </div>
                        <div class="carousel-item">
                            <img class="w-100 h-100" src="https://new.excelgiants.site/img/<?php echo $row_rsproducts['photo']; ?>" alt="Image">
                        </div>
                        <div class="carousel-item">
                            <img class="w-100 h-100" src="https://new.excelgiants.site/img/<?php echo $row_rsproducts['picture']; ?>" alt="Image">
                        </div>
                    </div>
            ...
            <div class="col-lg-7 h-auto mb-30">
                <div class="h-100 bg-light p-30">
                    <h3><?php echo $row_rsproducts['productName']; ?></h3>
                    ...
                    <h3 class="font-weight-semi-bold mb-4"><?php echo $row_rsproducts['productPrice']; ?> السعر</h3>
                  
                    <p class="mb-4"><?php echo $row_rsproducts['category']; ?></p>
                    <div class="d-flex align-items-center mb-4 pt-2">
<form action="" method="post" name="form" target="_new">

                    <table border="0" align="left" cellpadding="2" cellspacing="2" dir="rtl">
  <tr>
      <td align="right"><h2>الكمية:</h2></td>

    <td colspan="2" align="center"><div class="input-group quantity mr-3" style="width: 130px;">
      <h2><span class="input-group quantity mr-3" style="width: 130px;">
        <?php echo $_POST['b'];?>
      </span></h2>
    </div></td>
  </tr>
  <tr>
    <td align="right"><script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>

                      <input type="hidden" id="c" name="c">
                      <input type="hidden" id="a" value="<?php echo $row_rsproducts['productPrice']; ?>">
                  <h2> الاجمالي: </h2></td>
                   
    <td align="center"><h2><?php echo $_POST['c'];?></h2></td>
  </tr>
  <tr>
    <td colspan="2" align="center">                            <h1><a class="btn btn-primary px-3" href="https://api.whatsapp.com/send?phone=+96566634818&text=طلب شراء صنف من شركة فور كي للأنظمة الأمنية وكاميرات المراقبة - اسم الصنف : <?php echo $row_rsproducts['productName']; ?>. السعر : <?php echo $row_rsproducts['productPrice']; ?> -  الكمية: <?php echo $_POST['b'];?>- اجمالي السعر: <?php echo $_POST['c'];?>
" target="_new"><i class="fa fa-shopping-cart mr-1" style="font-size:24px"> تأكيد عملية الشراء </i></a>
    </h1></td>
    </tr>
</table>
            ...
            <div class="col">
                <div class="bg-light p-30">
                    <div class="nav nav-tabs mb-4">
                        <a class="nav-item nav-link text-dark active" data-toggle="tab" href="#tab-pane-1">وصف القسم</a>
                    </div>
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="tab-pane-1">
                            <h4 align="center" class="mb-3">وصف القسم</h4>
                          <p align="right"><?php echo $row_rsproducts['productDescription']; ?></p>
                      </div>
    ...
    <div class="container-fluid py-5">
        <h2 class="section-title position-relative text-uppercase mx-xl-5 mb-4"><span class="bg-secondary pr-3">منتجات أخرى قد تعجبك</span></h2>
        <div class="row px-xl-5">
            <div class="col">
