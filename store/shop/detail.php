...
if (!function_exists("GetSQLValueString")) {
  function GetSQLValueString($theValue, $theType, $theDefinedValue = "", $theNotDefinedValue = "") {
    ...
    // Always use MySQLi's escape function
...
<?php
// Select the database (optional if already done in the connection file)
...
<form action="confirm.php?id=<?php echo $row_rsproducts['id']; ?>" method="post" name="form">

                    <table border="0" align="left" cellpadding="2" cellspacing="2" dir="rtl">
  <tr>
      <td align="right"><h2>الكمية:</h2></td>

    <td colspan="2" align="center"><div class="input-group quantity mr-3" style="width: 130px;"><span class="input-group quantity mr-3" style="width: 130px;">
                        <input type="number" class="form-control bg-secondary border-0 text-center" value="1" id="b" name="b" onChange="add()" onKeyUp="add()" onKeyDown="add()" onload="add()" onFocus="add()" >
                            </span></div></td>
  </tr>
  <tr>
    ...
    <td align="center"><h2 id="demo"></h2></td>
  </tr>
  <tr>
