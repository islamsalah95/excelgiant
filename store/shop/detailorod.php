                ...
                <div class="h-100 bg-light p-30">
                    ...
                    <div class="d-flex align-items-center mb-4 pt-2">
                        <div class="input-group quantity mr-3" style="width: 130px;">
                            ...
                            <a class="btn btn-primary px-3" href="https://api.whatsapp.com/send?phone=+96566634818&text=طلب شراء صنف من شركة فور كي للأنظمة الأمنية وكاميرات المراقبة - اسم الصنف : <?php echo $row_rsproducts['productName']; ?>. السعر : <?php echo $row_rsproducts['productPrice']; ?> دينار" target="_new"><i class="fa fa-shopping-cart mr-1"></i></a>
                    </div>
