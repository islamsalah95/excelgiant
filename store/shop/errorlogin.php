                ...
                <div class="bg-light p-30">
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="tab-pane-1">
                            <h4 align="center" class="mb-3"><strong>خطأ .. اسم المستخدم او كلمة المرور غير صحيح</strong></h4>
                          <p align="center"><img src="error-img.gif" width="250" ></p>
                          <h4 align="center">حاول مرة أخرى من<a href="login.php"> هنا</a></h4>
                          <h4 align="center">أو قم بانشاء حساب جديد من<a href="newaccount.php"> هنا</a></h4>
                      </div>
