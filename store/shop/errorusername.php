                ...
                <div class="bg-light p-30">
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="tab-pane-1">
                            <h4 align="center" class="mb-3"><strong>خطأ .. اسم المستخدم موجود بالفعل </strong></h4>
                          <p align="center"><img src="error-img.gif" width="250" ></p>
                          <h4 align="center">حاول مرة أخرى من <a href="newaccount.php">هنا</a></h4>
                          <h4 align="center">أو قم بتسجيل الدخول من <a href="login.php">هنا</a></h4>
                      </div>
