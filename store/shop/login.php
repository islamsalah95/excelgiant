...
?>
<?php
// Redirect if username exists (for insertion)
$MM_flag = "MM_insert";
...
?>
<?php
// Query Recordset6: products with pagination
...
if (isset($_POST['username'])) {
  ...
  // Removed mysql_select_db call
  $LoginRS__query = sprintf("SELECT email, password FROM mostakhdem WHERE email=%s AND password=%s",
  ...
  <a href="https://wa.me/+96566634818" class="call" target="_new" title="راسلنا على الواتساب"><i class="fa fa-whatsapp"></i></a> 
      ...
      <div class="row align-items-center bg-light py-3 px-xl-5 d-none d-lg-flex">
        <div class="col-lg-4">
          <a href="index.php" class="text-decoration-none">
            <img src="finallogo.png" alt="" height="150">
          </a>
        </div>
        ...
        <div class="col-lg-3 d-none d-lg-block">
          <a class="btn d-flex align-items-center justify-content-between bg-primary w-100" data-toggle="collapse" href="#navbar-vertical" style="height: 65px; padding: 0 30px;">
            <h6 class="text-dark m-0">
              <i class="fa fa-bars mr-2"></i>الفئات
            </h6>
            <i class="fa fa-angle-down text-dark"></i>
          </a>
          <nav class="collapse position-absolute navbar navbar-vertical navbar-light align-items-start p-0 bg-light" id="navbar-vertical" style="width: calc(100% - 30px); z-index: 999;">
            <?php
            // We assume $Recordset1 was already set above from the query on category
            do {
            ?>
            <div class="navbar-nav w-100">
              <a href="category.php?category=<?php echo $row_Recordset1['categoryName'] ?? ''; ?>" class="nav-item nav-link">
        ...
        <div class="col-lg-9">
          <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
            <a href="" class="text-decoration-none d-block d-lg-none">
              <img src="finallogo1.png" height="100">
            </a>
            <form action="search.php" method="get">
              <div class="input-group">
                <input name="productName" type="text" class="form-control" id="productName" placeholder="البحث عن المنتجات">
      ...
      <div class="row px-xl-5">
        <div class="col-12">
          <nav class="breadcrumb bg-light mb-30">
            ...
            <span class="breadcrumb-item active">تسجيل الدخول</span>
          </nav>
        </div>
      </div>
    </div>
          ...
          <div class="bg-light p-30">
            <div class="tab-content">
              <div class="tab-pane fade show active" id="tab-pane-1">
                <h4 align="center" class="mb-3">تسجيل الدخول</h4>
                <p align="right"></p>
                <table border="1" align="center" cellpadding="10" cellspacing="10" dir="rtl">
                  <tr>
                    <td>
                      <form name="form1" method="POST" action="<?php echo $loginFormAction; ?>">
                        <table border="0" align="center" cellpadding="5" cellspacing="5" dir="rtl">
                          <tr>
                            <td>
                              <input name="username" type="text" id="username" size="32" placeholder="اسم المستخدم">
                            </td>
                          </tr>
                          <tr>
                            <td>
                              <input name="password" type="password" id="password" size="32"  placeholder="كلمة المرور">
                            </td>
                          </tr>
                          <tr>
                            <td align="center">
                              <input type="submit" name="button" id="button" value="دخول" class="btn btn-primary">
                            </td>
                          </tr>
                        </table>
                      </form>
    ...
    <div class="container-fluid py-5">
      <h2 class="section-title position-relative text-uppercase mx-xl-5 mb-4">
        <span class="bg-secondary pr-3">منتجات قد تعجبك</span>
      </h2>
      <div class="row px-xl-5">
        <div class="col">
            ...
            <div class="product-item bg-light">
              <div class="product-img position-relative overflow-hidden">
                ...
                <div class="product-action">
                  <a class="btn btn-outline-dark btn-square" href="https://api.whatsapp.com/send?phone=+96566634818&text=طلب شراء صنف من شركة فور كي للأنظمة الأمنية وكاميرات المراقبة - اسم الصنف : <?php echo $row_Recordset6['productName'] ?? ''; ?>. السعر : <?php echo $row_Recordset6['productPrice'] ?? ''; ?> دينار" target="_new">
                    <i class="fa fa-shopping-cart"></i>
                  </a>
                  <a class="btn btn-outline-dark btn-square" href="detail.php?id=<?php echo $row_Recordset6['id'] ?? ''; ?>">
                    <i class="fa fa-eye"></i>
                  </a>
                </div>
              </div>
              <div class="text-center py-4">
                <a class="h6 text-decoration-none text-truncate" href="detail.php?id=<?php echo $row_Recordset6['id'] ?? ''; ?>">
                  <?php echo $row_Recordset6['productName'] ?? ''; ?>
                </a>
                <div class="d-flex align-items-center justify-content-center mt-2">
                  <h5><?php echo $row_Recordset6['productPrice'] ?? ''; ?></h5>
                  <h6 class="text-muted ml-2">السعر</h6>
                </div>
              </div>
            </div>
    ...
    <div class="container-fluid bg-dark text-secondary mt-5 pt-5">
      <div class="row px-xl-5 pt-5">
        <div class="col-lg-4 col-md-12 mb-5 pr-3 pr-xl-5">
          ...
          <p class="mb-2">
            <i class="fas fa-map-marker-alt text-primary mr-3"></i><?php echo $row_Recordset5['work_place'] ?? ''; ?>
          </p>
          <p class="mb-2">
            <i class="fa fa-envelope text-primary mr-3"></i><?php echo $row_Recordset5['grad_place'] ?? ''; ?>
          </p>
          <p class="mb-0">
            <i class="fa fa-phone-alt text-primary mr-3"></i><?php echo $row_Recordset5['country'] ?? ''; ?>
          </p>
        </div>
            ...
            <div class="col-md-4 mb-5">
              ...
              <div class="d-flex flex-column justify-content-start">
                <a class="text-secondary mb-2" href="index.php">
                  <i class="fa fa-angle-right mr-2"></i>الرئيسية
                </a>
                <a class="text-secondary mb-2" href="about.php">
                  <i class="fa fa-angle-right mr-2"></i>تعرف علينا
                </a>
                <a class="text-secondary" href="contact.php">
                  <i class="fa fa-angle-right mr-2"></i>اتصل بنا
                </a>
              </div>
            </div>
            <div class="col-md-4 mb-5">
              ...
              <div class="d-flex flex-column justify-content-start">
                <a class="text-secondary mb-2" href="login.php">
                  <i class="fa fa-angle-right mr-2"></i>تسجيل الدخول
                </a>
                <a class="text-secondary mb-2" href="newaccount.php">
                  <i class="fa fa-angle-right mr-2"></i>حساب جديد
                </a>
              </div>
            </div>
            <div class="col-md-4 mb-5">
              ...
              <div class="d-flex">
                <a class="btn btn-primary btn-square mr-2" href="<?php echo $row_Recordset5['create_by'] ?? ''; ?>">
                  <i class="fab fa-facebook-f"></i>
                </a>
                <a class="btn btn-primary btn-square mr-2" href="<?php echo $row_Recordset5['edit_by'] ?? ''; ?>">
      ...
      <div class="row border-top mx-xl-5 py-4" style="border-color: rgba(256, 256, 256, .1) !important;">
        <div class="col-md-6 px-xl-0" dir="rtl">
          <p class="mb-md-0 text-center text-md-left text-secondary">
            &copy; <a class="text-primary" href="#"><?php echo $row_Recordset5['first_name'] ?? ''; ?></a>.
            جميع الحقوق محفوظة. تصميم وبرمجة 
