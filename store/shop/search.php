...
if (isset($_GET['productName'])) {
  $colname_Recordset2 = $_GET['productName'];
}
mysqli_select_db($connection, "excelgia_mahmdata");
$query_Recordset2 = sprintf("SELECT * FROM products WHERE productName LIKE %s", GetSQLValueString("%" . $colname_Recordset2 . "%", "text"));
    ...
    <div class="container-fluid bg-dark text-secondary mt-5 pt-5">
      <div class="row px-xl-5 pt-5">
        <div class="col-lg-4 col-md-12 mb-5 pr-3 pr-xl-5">
          ...
          <p class="mb-2"><i class="fas fa-map-marker-alt text-primary mr-3-marker-alt text-primary mr-3"></i><?php echo $row_Recordset5['work_place']; ?></p>
